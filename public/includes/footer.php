...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700"><?= date("Y")?>  ©  <?= APP_TITLE.' - '.APP_DESCRIPTION ?> by &nbsp;<a href='<?= APP_OWNER_URL ?>' class='text-primary fw-500' title='<?= APP_DESCRIPTION ?>' target='_blank'><?= APP_OWNER_NAME ?></a></span>
    </div>
    <div>
        <ul class="list-table m-0">
            <li><a href="<?= APP_URL ?>/intel_introduction.php" class="text-secondary fw-700">About</a></li>
            <li class="pl-3"><a href="<?= APP_URL ?>/docs_licensing.php" class="text-secondary fw-700">License</a></li>
            <li class="pl-3"><a href="<?= APP_URL ?>/docs_general.php" class="text-secondary fw-700">Documentation</a></li>
