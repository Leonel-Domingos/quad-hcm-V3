...
<header class="page-header" role="banner">
    ...
    <div>
        ...
        <span id="activity" class="activity-dropdown" title="<?php echo $ui_processes_running; ?>"> <i class="fas fa-cogs" style="color:#c2c2c2"></i> <b id="processCtrl" class="badge badge-secondary" style="">0</b> </span>

        <!-- AJAX-DROPDOWN : control this dropdown height, look and feel from the LESS variable file -->
        <div class="ajax-dropdown">

            <!-- the ID links are fetched via AJAX to the ajax container "ajax-notifications" -->
            <div style="margin: 0 0 3px; padding: 0 0 3px;">
                <h6 style="text-align: center;">Processos </h6>
            </div>

            <!-- notification content -->
            <div class="ajax-notifications custom-scroll" onmouseover="document.body.style.overflow='hidden';" onmouseout="document.body.style.overflow='hidden';">
            ...
            <span style="margin-top: 2px;">
                <button id="clearProcesses" type="button" class="btn btn-xs btn-default pull-right">
    ...
    <div class="ml-auto d-flex">
                        ...
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-c.png')"></span>
                                        </span>
                                ...
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-a.png')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-b.png')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-warning mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-e.png')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <img src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-m.png" data-src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" />
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-h.png')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-m.png')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-danger mr-2">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-j.png')"></span>
                                        </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                    ...
                    <div class="tab-pane" id="tab-feeds" role="tabpanel">
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                    ...
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <span class="d-flex flex-column flex-1">
                                            ...
                                            <span class="msg-a fs-sm">
                                                System updated to version <strong>4.4.6</strong> <a href="<?= APP_URL ?>/docs_buildnotes.php">(patch notes)</a>
                                            </span>
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <img src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-m.png" data-src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-k.png" class="profile-image rounded-circle" alt="k" />
                                        <div class="d-flex flex-column flex-1">
                                            <span class="name">
                                                Troy Norman'<span class="fw-300">s new connections</span>
                                            </span>
                                            <div class="fs-sm d-flex align-items-center mt-2">
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-a.png'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-b.png'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-c.png'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-e.png'); background-size: cover;"></span>
                                                <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-h.png'); background-size: cover;"></span>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <img src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-m.png" data-src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-e.png" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />
                                        <div class="d-flex flex-column flex-1">
                                        ...
                                        <div class="d-flex flex-column flex-1">
                                            ...
                                            <div class="fs-sm d-flex align-items-center mt-1">
                                                <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                    <span class="d-block img-share" style="background-image:url('<?= ASSETS_URL ?>/img/thumbs/pic-7.png'); background-size: cover;"></span>
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                    <span class="d-block img-share" style="background-image:url('<?= ASSETS_URL ?>/img/thumbs/pic-8.png'); background-size: cover;"></span>
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                    <span class="d-block img-share" style="background-image:url('<?= ASSETS_URL ?>/img/thumbs/pic-11.png'); background-size: cover;"></span>
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                    <span class="d-block img-share" style="background-image:url('<?= ASSETS_URL ?>/img/thumbs/pic-12.png'); background-size: cover;"></span>
                                                </a>
                                            </div>
                                            <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                        </div>
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <img src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-m.png" data-src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-h.png" class="profile-image rounded-circle align-self-start mt-1" alt="k" />
                                        <div class="d-flex flex-column flex-1">
                                            <div class="name mb-2">
        ...
        <!-- app user menu -->
        <div id="app_user_menu">
            <a href="#" data-toggle="dropdown" title="<?= $_user->NOME ? : $_user->UTILIZADOR ?>" class="header-icon d-flex align-items-center justify-content-center ml-2">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                        <span class="mr-2">
                            <?= $_user->get_user_thumbnail()?>
                            <!--img src="<?= ASSETS_URL ?>/img/demo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="<?= $_user->NOME ? : $_user->UTILIZADOR ?>"-->
                        </span>
                        <div class="info-card-text">
                            <div class="fs-lg text-truncate text-truncate-lg"><?= $_user->NOME_REDZ ? : $_user->UTILIZADOR ?></div>
                            <span class="text-truncate text-truncate-md opacity-80"><?= $_user->EMAIL ?></span>
                        </div>
                    </div>
                </div>
                <div class="dropdown-divider m-0"></div>
                <a href="#" class="dropdown-item" data-action="change-password">
                    <span data-i18n="drpdwn.reset_layout"><?= $ui_change_password ?></span>
                </a>
                <div class="dropdown-multilevel dropdown-multilevel-left">
                    <div class="dropdown-item">
                        <?= $ui_idiom ?>
                    </div>
                    <?= $app->show_avail_lang_list() ?>
                    <!--
                ...
                <a href="#" class="dropdown-item" data-action="app-reset">
                    <span data-i18n="drpdwn.reset_layout"><?= $ui_reset_layout ?></span>
                </a>
                <a href="#" class="dropdown-item" data-toggle="modal" data-target=".js-modal-settings">
                    <span data-i18n="drpdwn.settings"><?= $ui_settings ?></span>
                </a>
                <div class="dropdown-divider m-0"></div>
                <a href="#" class="dropdown-item" data-action="app-fullscreen">
                    <span data-i18n="drpdwn.fullscreen"><?= $ui_fullscreen ?></span>
                    <i class="float-right text-muted fw-n">F11</i>
                </a>
                <a href="#" class="dropdown-item" data-action="app-print">
                    <span data-i18n="drpdwn.print"><?= $ui_print ?></span>
                    <i class="float-right text-muted fw-n">Ctrl + P</i>
                </a>
                <div class="dropdown-divider m-0"></div>
                <a class="dropdown-item fw-500 pt-3 pb-3" data-action="logout" data-logout-msg=" " data-href="<?= APP_URL ?>/logout.php">
                    <span data-i18n="drpdwn.page-logout"><?= $ui_logout ?></span>
                    <span class="float-right fw-n">&commat;<?= $_user->UTILIZADOR ?></span>
                </a>
            </div>
        </div>
    </div>
