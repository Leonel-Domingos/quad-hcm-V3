...
<input class="form-control visibleColumn" name="ACRONIMO">
                            ...
                            <div class="tab-pane fade" id="Tab2" role="tabpanel">
                                ...
                                <table id="RH_ID_FUNCOES" class="table responsive table-bordered table-striped table-hover nowrap"></table>
                                ...
                                <div class="panel-hdr border-faded border-top-0 border-right-0 border-left-0 shadow-0 justify-content-start">
                                    <div class="panel-toolbar pr-3 align-self-end">
                                        <ul id="panel-tab-2-1" class="nav nav-tabs border-bottom-0 justify-content-end" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#Tab22" role="tab" aria-selected="true"><?php echo $ui_remuneration_elements; ?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#Tab23" role="tab" aria-selected="true"><?php echo $ui_rhid_folder_classifications; ?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#Tab24" role="tab" aria-selected="true"><?php echo $ui_remunerations; ?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#Tab25" role="tab" aria-selected="true"><?php echo $ui_structure; ?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#Tab26" role="tab" aria-selected="true"><?php echo $ui_workflows; ?> </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-content">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="Tab23" role="tabpanel">
                                                ...
                                                <div class="row mt-4 FUNCOES_VINCULOS">
...
//                    console.log(conf_CADASTRO['RH_IDENTIFICACOES']["crud"]);
    ...
    //                        "className": "none visibleColumn",
        ...
        //                },
                ...
                //Informação Profissional + Funções
                if  ( !conf_CADASTRO['RH_ID_PROFISSIONAIS']["access"] && !conf_CADASTRO['RH_ID_FUNCOES']["access"] && !conf_CADASTRO['RH_ID_VINCULOS']["access"] ) {
                    ...
                    if  ( !conf_CADASTRO['RH_ID_FUNCOES']["access"] && !conf_CADASTRO['RH_ID_VINCULOS']["access"] ) {
                        $('fieldset.FUNCOES_VINCULOS').remove();
                    } else {
