...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <span class="widget-icon"> <i class="fas fa-user-minus"></i></span>&nbsp;
                <h2><?php echo $ui_account_settling; ?></h2>
            </div>
...
<script>
    ...
    var y = "<?php echo @$_SESSION['lang']; ?>",
        perfil_ = "<?php echo @$_SESSION['perfil'];?>",
        rhid_ = "<?php echo @$_SESSION['rhid'];?>",
        whereClause_ = " A.TP_DESPESA = 'C' "; //Acerto Contas Automáticos
...
//                    "render": function () {
//                        return RH_ID_CONTAS_CORRENTES.crudButtons(true,true,true);
//                    }
                }
            ],
...
//                    "className": "toBottom toCenter",
//                    "render": function () {
//                        return RH_ID_DET_CONTAS_CORRENTES.crudButtons(false,false,false);
//                    }
                }
            ],
            "validations": {
