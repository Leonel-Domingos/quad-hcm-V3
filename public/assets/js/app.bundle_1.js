...
!(function (i) {
    i.fn.extend({
        navigation: function (e) {
            var n = i.extend({ accordion: !0, animate: "easeOutExpo", speed: 200, closedSign: "[+]", openedSign: "[-]", initClass: "js-nav-built" }, e),
                o = i(this);
            o.hasClass(n.initClass)
                ? myapp_config.debugState && console.log(o.get(0) + " this menu already exists")
                : (o.addClass(n.initClass),
                  ...
                  o.find("li a").on("mousedown", function (e) {
                      0 !== i(this).parent().find("ul").length &&
                          (n.accordion &&
                              (i(this).parent().find("ul").is(":visible") ||
                                  ((parents = i(this).parent().parents("ul")),
                                  ...
                                  visible.each(function (o) {
                                      ...
                                      parents.each(function (e) {
                                          ...
                                          t &&
                                              i(this).parent().find("ul") != visible[o] &&
                                              i(visible[o]).slideUp(n.speed + 300, n.animate, function () {
                          ...
                          i(this).parent().find("ul:first").is(":visible") && !i(this).parent().find("ul:first").hasClass("active")
                              ? i(this)
                                    .parent()
                                    .find("ul:first")
            ...
            (self = i(this)),
                self.hasClass(myapp_config.navInitalized)
                    ? (self.find("li").removeClass("active open"),
                      ...
                      myapp_config.debugState && console.log(self.get(0) + " destroyed"))
    ...
    (function (p) {
        ...
        function i(e, t) {
            ...
            function c() {
                (o = p("#" + t.wrapperId).outerWidth()),
                    (i = p
                        .map(l.children("li:not(.nav-title)"), function (e) {
                            return p(e).outerWidth(!0);
                        })
                        .reduce(function (e, o) {
                            return e + o;
                        }, 0)),
                    (n = parseFloat(l.css("margin-left")));
            }
            return (
                (t = p.extend({}, p.fn[f].defaults, t)),
                l.css("margin-left", "0px"),
                l.wrap('<div id="' + t.wrapperId + '" class="nav-menu-wrapper d-flex flex-grow-1 width-0 overflow-hidden"></div>'),
                p("#" + t.wrapperId).before(
                    '<a href="#" id="' + t.wrapperId + '-left-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-2 ml-1 p-0 fs-xxl text-primary"><i class="fal fa-angle-left"></i></a>'
                ),
                p("#" + t.wrapperId).after(
                    '<a href="#" id="' + t.wrapperId + '-right-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-1 ml-2 p-0 fs-xxl text-primary"><i class="fal fa-angle-right"></i></a>'
                ),
                p.map(l.children("li:not(.nav-title)"), function (e) {
                    return p(e).outerWidth(!0);
                }),
                p("#" + t.wrapperId + "-left-btn").click(function (e) {
                    c(), n < 0 ? (a = Math.min(n + o, 0)) : ((a = n), console.log("left end")), l.css({ marginLeft: a }), e.preventDefault();
                }),
                p("#" + t.wrapperId + "-right-btn").click(function (e) {
                    c(), -n + o < i ? (a = Math.max(n - o, -(i - o))) : ((a = n), console.log("right end")), l.css({ marginLeft: a }), e.preventDefault();
                }),
                s("onInit"),
                {
                    option: function (e, o) {
                    ...
                    destroy: function (e) {
                        l.each(function () {
                            var e = p(this);
                            e.css("margin-left", "0px"), e.unwrap(parent), e.prev().off().remove(), e.next().off().remove(), s("onDestroy"), e.removeData("plugin_" + f);
                        });
                    },
                }
            );
        ...
        (p.fn[f] = function (e) {
            ...
            (p.fn[f].defaults = { onInit: function () {}, onDestroy: function () {}, element: myapp_config.navHooks, wrapperId: myapp_config.navHorizontalWrapperId });
    })(jQuery);
var initApp = (function (e) {
    return (
        (e.listFilter = function (t, e, o) {
                ...
                $(e)
                    .change(function () {
                        ...
                        return (
                            1 < e.length
                                ? ($(t)
                                      .find($("[data-filter-tags]:not([data-filter-tags*='" + e + "'])"))
                                      .parentsUntil(t)
                                  ...
                                  o && o.text("showing " + $(t).find("li.js-filter-show").length + " from " + $(t).find("[data-filter-tags]").length + " total"))
                                : ($(t).find("[data-filter-tags]").parentsUntil(t).removeClass("js-filter-hide js-filter-show"), o && o.text("")),
                            !1
                        );
                    })
                    .keyup(
        ...
        (e.loadScript = function (e, o) {
            if (myapp_config.jsArray[e]) myapp_config.debugState && console.log("This script was already loaded: " + e);
            else {
        ...
        (e.saveSettings = function () {
            "undefined" != typeof saveSettings && $.isFunction(saveSettings) && myapp_config.storeLocally
                ? (initApp.accessIndicator(), saveSettings(), myapp_config.debugState && console.log("Theme settings: \n" + localStorage.getItem("themeSettings")))
                : console.log("save function does not exist");
        }),
        (e.updateTheme = function (e, o) {
            $(myapp_config.mythemeAnchor).length ? $(myapp_config.mythemeAnchor).attr("href", e) : $("head").append($("<link>", { id: myapp_config.mythemeAnchor.replace("#", ""), rel: "stylesheet", href: e })),
            ...
            initApp.playSound(myapp_config.assetsUrl + "/media/sound", "messagebox"),
                ...
                "undefined" != typeof bootbox
                    ? bootbox.confirm({
                          ...
                          centerVertical: !0,
                          swapButtonOrder: !0,
                          buttons: { confirm: { label: "Factory Reset", className: "btn-warning shadow-0" }, cancel: { label: "Cancel", className: "btn-success" } },
                    ...
                    : confirm("You are about to reset all of your localStorage to null state. Do you wish to continue?") && (localStorage.clear(), initApp.resetSettings(), location.reload()),
                myapp_config.debugState && console.log("App reset successful");
        }),
        ...
        (e.detectBrowserType = function () {
            return myapp_config.isChrome
                ? (myapp_config.root_.addClass("chrome webkit"), "chrome webkit")
                : myapp_config.isWebkit
                ? (myapp_config.root_.addClass("webkit"), "webkit")
                : myapp_config.isIE
                ? (myapp_config.root_.addClass("ie"), "ie")
                : void 0;
        }),
        ...
        (e.windowScrollEvents = function () {
            myapp_config.root_.is(".nav-function-hidden.header-function-fixed:not(.nav-function-top)") && "desktop" === myapp_config.thisDevice
                ? myapp_config.root_logo.css({ top: $(window).scrollTop() })
        ...
        (e.checkNavigationOrientation = function () {
            switch (!0) {
                case myapp_config.root_.hasClass("nav-function-fixed") && !myapp_config.root_.is(".nav-function-top, .nav-function-minify, .mod-main-boxed") && "desktop" === myapp_config.thisDevice:
                    void 0 !== $.fn.slimScroll
                        ? (myapp_config.navAnchor.slimScroll({ height: "100%", color: "#fff", size: "4px", distance: "4px", railOpacity: 0.4, wheelStep: 10 }),
                          document.getElementById(myapp_config.navHorizontalWrapperId) && (myapp_config.navHooks.menuSlider("destroy"), myapp_config.debugState && console.log("----top controls destroyed")),
                          myapp_config.debugState && console.log("slimScroll created"))
                ...
                case myapp_config.navAnchor.parent().hasClass("slimScrollDiv") && "desktop" === myapp_config.thisDevice && void 0 !== $.fn.slimScroll:
                    myapp_config.navAnchor.slimScroll({ destroy: !0 }),
            ...
            switch (!0) {
                case $.fn.menuSlider && myapp_config.root_.hasClass("nav-function-top") && 0 == $("#js-nav-menu-wrapper").length && !myapp_config.root_.hasClass("mobile-view-activated"):
                    myapp_config.navHooks.menuSlider({ element: myapp_config.navHooks, wrapperId: myapp_config.navHorizontalWrapperId }), myapp_config.debugState && console.log("----top controls created -- case 1");
                    break;
        ...
        (e.mobileCheckActivation = function () {
            return (
                window.innerWidth < myapp_config.mobileResolutionTrigger
                    ? (myapp_config.root_.addClass("mobile-view-activated"), (myapp_config.mobileMenuTrigger = !0))
                    : (myapp_config.root_.removeClass("mobile-view-activated"), (myapp_config.mobileMenuTrigger = !1)),
        ...
        (e.domReadyMisc = function () {
            if (
                ...
                var e = new Date(),
                    o =
                        ...
                        ", " +
                        ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][e.getMonth()] +
                        " " +
                        e.getDate() +
                        ", " +
                        e.getFullYear();
            ...
            if ((initApp.checkNavigationOrientation(), myapp_config.activateLastTab)) {
            ...
            if (
                (void 0 !== $.fn.slimScroll && "desktop" === myapp_config.thisDevice
                    ? ($(".custom-scroll:not(.disable-slimscroll) >:first-child").slimscroll({
                      ...
                      myapp_config.debugState && console.log("%c✔ SlimScroll plugin active", "color: #148f32"))
                    : (console.log("WARN! $.fn.slimScroll not loaded or user is on desktop"), myapp_config.root_.addClass("no-slimscroll")),
            ...
            if ((void 0 !== $.fn.tooltip && $('[data-toggle="tooltip"]').length ? $('[data-toggle="tooltip"]').tooltip() : console.log("OOPS! bs.tooltip is not loaded"), void 0 !== $.fn.popover && $('[data-toggle="popover"]').length)) {
                $.fn.tooltip.Constructor.Default.whiteList;
                $('[data-toggle="popover"]').popover({ sanitize: !1 });
            }
            if (
                (void 0 !== $.fn.dropdown ? (Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1) : console.log("OOPS! bs.popover is not loaded"),
                ...
                window.Waves && myapp_config.rippleEffect
                    ? (Waves.attach(".nav-menu:not(.js-waves-off) a, .btn:not(.js-waves-off):not(.btn-switch), .js-waves-on", ["waves-themed"]),
                      Waves.init(),
                      myapp_config.debugState && console.log("%c✔ Waves plugin active", "color: #148f32"))
                    : myapp_config.debugState && console.log("%c✘ Waves plugin inactive! ", "color: #fd3995"),
                    ...
                    switch (!0) {
                        case "toggle" === o:
                            ...
                            -1 !== n.indexOf("mod-bg-") &&
                                ...
                                ("undefined" == typeof classHolder && null == classHolder) || (initApp.checkNavigationOrientation(), initApp.saveSettings());
                            break;
                        case "toggle-swap" === o:
                        ...
                        case "panel-collapse" === o:
                            (l = $(this).closest(".panel"))
                                ...
                                .on("show.bs.collapse", function () {
                                    l.removeClass("panel-collapsed"), myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: uncollapsed");
                                })
                                .on("hidden.bs.collapse", function () {
                                    l.addClass("panel-collapsed"), myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: collapsed");
                                });
                            break;
                        case "panel-fullscreen" === o:
                            (l = $(this).closest(".panel")).toggleClass("panel-fullscreen"), myapp_config.root_.toggleClass("panel-fullscreen"), myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: fullscreen");
                            break;
                        case "panel-close" === o:
                            function a() {
                                l.fadeOut(500, function () {
                                    $(this).remove(), myapp_config.debugState && console.log("panel id:" + l.attr("id") + " | action: removed");
                                });
                            }
                            ...
                            "undefined" != typeof bootbox
                                ? (initApp.playSound(myapp_config.assetsUrl + "/media/sound", "messagebox"),
                                  bootbox.confirm({
                                      title:
                                          "<i class='" +
                                          myapp_config.appIconPrefix +
                                          " fa-times-circle text-danger mr-2'></i> Do you wish to delete panel <span class='fw-500'>&nbsp;'" +
                                ...
                                : confirm("Do you wish to delete panel " + l.children(".panel-hdr").children("h2").text().trim() + "?") && a();
                            break;
                        case "theme-update" === o:
                        ...
                        case "app-loadscript" === o:
                            var r = $(this).attr("data-loadurl"),
                                s = $(this).attr("data-loadfunction");
                            initApp.loadScript(r, s);
                            break;
                        case "lang" === o:
                            var c = $(this).attr("data-lang").toString();
                            $.i18n
                                ? i18n.setLng(c, function () {
                                      $("[data-i18n]").i18n(), $("[data-lang]").removeClass("active"), $(this).addClass("active");
                                  })
                                : initApp.loadScript("js/i18n/i18n.js", function () {
                                      $.i18n.init({ resGetPath: myapp_config.assetsUrl + "/media/data/__lng__.json", load: "unspecific", fallbackLng: !1, lng: c }, function (e) {
                                          $("[data-i18n]").i18n(), $("[data-lang]").removeClass("active"), $('[data-lang="' + c + '"]').addClass("active");
                                      });
                                  });
                            break;
                        case "app-fullscreen" === o:
                            document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement
                                ? (document.exitFullscreen
                                  ...
                                  myapp_config.debugState && console.log("%capp fullscreen toggle inactive! ", "color: #ed1c24"))
                            ...
                            break;
                        case "playsound" === o:
                            var p = $(this).attr("data-soundpath") || myapp_config.assetsUrl + "/media/sound/",
                                f = $(this).attr("data-soundfile");
                            initApp.playSound(p, f);
                    }
