(function () {
    ...
    for (
        v = {
            ...
            A = function () {
                var t, e, n;
                return (n = arguments[0]), (e = arguments[1]), (t = 3 <= arguments.length ? $.call(arguments, 2) : []), "function" == typeof n[e] ? n[e].apply(n, t) : n[e];
            },
            x = function () {
                var t, e, n, i, o, r, s;
                for (e = arguments[0], r = 0, s = (i = 2 <= arguments.length ? $.call(arguments, 1) : []).length; r < s; r++)
                    if ((n = i[r])) for (t in n) G.call(n, t) && ((o = n[t]), null != e[t] && "object" == typeof e[t] && null != o && "object" == typeof o ? x(e[t], o) : (e[t] = o));
                return e;
            },
            g = function (t) {
                var e, n, i, o, r;
            ...
            Z.prototype.on = function (t, e, n, i) {
                var o;
                return null == i && (i = !1), null == this.bindings && (this.bindings = {}), null == (o = this.bindings)[t] && (o[t] = []), this.bindings[t].push({ handler: e, ctx: n, once: i });
            },
            ...
            Z.prototype.trigger = function () {
                ...
                if (((n = arguments[0]), (t = 2 <= arguments.length ? $.call(arguments, 1) : []), null != (s = this.bindings) ? s[n] : void 0)) {
                    for (o = 0, l = []; o < this.bindings[n].length; ) (i = (a = this.bindings[n][o]).handler), (e = a.ctx), (r = a.once), i.apply(null != e ? e : this, t), r ? l.push(this.bindings[n].splice(o, 1)) : l.push(o++);
                    return l;
                }
            },
            o = Z,
    ...
    function it() {
            ...
            (n = function (i) {
                ...
                return (
                    ...
                    (i.open = function (t, e, n) {
                        return H(t) && r.trigger("request", { type: t, url: e, request: i }), o.apply(i, arguments);
                    })
                );
            }),
        ...
        if (null != W && P.ajax.trackWebSockets) {
            window.WebSocket = function (t, e) {
                var n;
                return (n = null != e ? new W(t, e) : new W(t)), H("socket") && r.trigger("request", { type: "socket", url: t, protocols: e, request: n }), n;
            };
            try {
    ...
    (Q = Error),
        ...
        (et.prototype.render = function () {
            ...
            for (t = this.getElement(), i = "translate3d(" + this.progress + "%, 0, 0)", o = 0, r = (s = ["webkitTransform", "msTransform", "transform"]).length; o < r; o++) (e = s[o]), (t.children[0].style[e] = i);
            return (
        ...
        (nt.prototype.trigger = function (t, e) {
            ...
            if (null != this.bindings[t]) {
                for (s = [], i = 0, o = (r = this.bindings[t]).length; i < o; i++) (n = r[i]), s.push(n.call(this, e));
                return s;
            }
        }),
        ...
        (b.ignore = function () {
            var t, e, n;
            return (e = arguments[0]), (t = 2 <= arguments.length ? $.call(arguments, 1) : []), k.unshift("ignore"), (n = e.apply(null, t)), k.shift(), n;
        }),
        (b.track = function () {
            var t, e, n;
            return (e = arguments[0]), (t = 2 <= arguments.length ? $.call(arguments, 1) : []), k.unshift("track"), (n = e.apply(null, t)), k.shift(), n;
        }),
        (H = function (t) {
            var e;
        ...
        (T = function () {
            ...
            if (((a = t.type), (s = t.request), (n = t.url), !j(n)))
                return b.running || (!1 === P.restartOnRequestAfter && "force" !== H(a))
                    ? void 0
                    : ((r = arguments),
                      ...
                      setTimeout(function () {
                          ...
                          if ("socket" === a ? s.readyState < 2 : 0 < (n = s.readyState) && n < 4) {
                              for (b.restart(), o = [], t = 0, e = (i = b.sources).length; t < e; t++) {
        ...
        (ot.prototype.watch = function (t) {
            var e, n, i, o;
            if (((i = t.type), (e = t.request), (o = t.url), !j(o))) return (n = "socket" === i ? new f(e) : new p(e)), this.elements.push(n);
        }),
        (l = ot),
        (p = function (e) {
            var t,
        ...
        (f = function (t) {
            var e,
                ...
                o,
                r = this;
            for (n = this.progress = 0, i = (o = ["error", "open"]).length; n < i; n++)
                (e = o[n]),
                    t.addEventListener(
                        e,
                        function () {
        ...
        (n = function (t) {
            var e, n, i, o;
            for (null == t && (t = {}), this.elements = [], null == t.selectors && (t.selectors = []), n = 0, i = (o = t.selectors).length; n < i; n++) (e = o[n]), this.elements.push(new r(e));
        }),
            ...
            (this.progress = 0),
                ...
                (n = setInterval(function () {
                    ...
                    return (
                        ...
                        (e = g(r)),
                        ++o >= P.eventLag.minSamples && e < P.eventLag.lagThreshold ? ((s.progress = 100), clearInterval(n)) : (s.progress = (3 / (e + 3)) * 100)
                    );
                }, 50));
        }),
        ...
        (h = { ajax: l, elements: n, document: e, eventLag: i }),
        (D = function () {
            var t, e, n, i, o, r, s, a;
            for (b.sources = R = [], e = 0, i = (r = ["ajax", "elements", "document", "eventLag"]).length; e < i; e++) !1 !== P[(t = r[e])] && R.push(new h[t](P[t]));
            for (n = 0, o = (a = null != (s = P.extraSources) ? s : []).length; n < o; n++) (M = a[n]), R.push(new M(P));
            return (b.bar = _ = new c()), (L = []), (q = new y());
        })(),
        (b.stop = function () {
            return b.trigger("stop"), (b.running = !1), _.destroy(), (w = !0), null != d && ("function" == typeof m && m(d), (d = null)), D();
        }),
        (b.restart = function () {
        ...
        (b.go = function () {
            ...
            return (
                ...
                (d = O(function (t, e) {
                    ...
                    for (100 - _.progress, i = h = 0, o = !0, a = f = 0, d = R.length; f < d; a = ++f)
                        for (M = R[a], u = null != L[a] ? L[a] : (L[a] = []), l = p = 0, g = (s = null != (m = M.elements) ? m : [M]).length; p < g; l = ++p)
                            (r = s[l]), (o &= (c = null != u[l] ? u[l] : (u[l] = new y(r))).done), c.done || (i++, (h += c.tick(t)));
                    return (
                        (n = h / i),
                        _.update(q.tick(t, n)),
                        _.done() || o || w
    ...
    (function (t, e) {
                            ...
                            (i = t[e]),
                                "__proto__" !== e &&
                                    ...
                                    (c && i && (T.isPlainObject(i) || (o = Array.isArray(i)))
                                        ? ((n = s[e]), (r = o && !Array.isArray(n) ? [] : o || T.isPlainObject(n) ? n : {}), (o = !1), (s[e] = T.extend(c, r, i)))
                                        : void 0 !== i && (s[e] = i));
                return s;
            }),
            T.extend({
                ...
                map: function (t, e, n) {
                    var i,
                        ...
                        r = 0,
                        s = [];
                    if (f(t)) for (i = t.length; r < i; r++) null != (o = e(t[r], r, n)) && s.push(o);
        ...
        var p = (function (n) {
            ...
            try {
                j.apply((e = H.call(y.childNodes)), y.childNodes), e[y.childNodes.length].nodeType;
            } catch (t) {
                j = {
                    apply: e.length
                        ? function (t, e) {
                ...
                if (!i && ((t ? t.ownerDocument || t : y) !== C && x(t), (t = t || C), E)) {
                    if (11 !== f && (l = et.exec(e)))
                        if ((o = l[1])) {
                            ...
                            if ((o = l[3]) && p.getElementsByClassName && t.getElementsByClassName) return j.apply(n, t.getElementsByClassName(o)), n;
                        }
                    if (p.qsa && !P[e + " "] && (!m || !m.test(e)) && (1 !== f || "object" !== t.nodeName.toLowerCase())) {
                        if (((u = e), (h = t), 1 === f && K.test(e))) {
                            for ((a = t.getAttribute("id")) ? (a = a.replace(ot, rt)) : t.setAttribute("id", (a = T)), r = (c = d(e)).length; r--; ) c[r] = "#" + a + " " + yt(c[r]);
                            (u = c.join(",")), (h = (nt.test(e) && vt(t.parentNode)) || t);
                        }
                        try {
                ...
                return (
                    i !== C &&
                        ...
                        (p.qsa = tt.test(C.querySelectorAll)) &&
                            (ut(function (t) {
                                (a.appendChild(t).innerHTML = "<a id='" + T + "'></a><select id='" + T + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                    ...
                                    t.querySelectorAll("[selected]").length || m.push("\\[" + q + "*(?:value|" + R + ")"),
                        ...
                        (p.matchesSelector = tt.test((v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector))) &&
                            ut(function (t) {
                                (p.disconnectedMatch = v.call(t, "*")), v.call(t, "[s!='']:x"), u.push("!=", B);
                            }),
                        ...
                        (N = e
                            ? function (t, e) {
                                  ...
                                  return (
                                      n ||
                                      (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || (!p.sortDetached && e.compareDocumentPosition(t) === n)
            ...
            (at.matchesSelector = function (t, e) {
                if (((t.ownerDocument || t) !== C && x(t), p.matchesSelector && E && !P[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))))
                    try {
                        var n = v.call(t, e);
            ...
            (at.attr = function (t, e) {
                ...
                var n = _.attrHandle[e.toLowerCase()],
                    i = n && A.call(_.attrHandle, e.toLowerCase()) ? n(t, e, !E) : void 0;
                ...
                preFilter: {
                    ...
                    PSEUDO: function (t) {
                        ...
                        return $.CHILD.test(t[0])
                            ? null
                            : (t[3] ? (t[2] = t[4] || t[5] || "") : n && X.test(n) && (e = d(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && ((t[0] = t[0].slice(0, e)), (t[2] = n.slice(0, e))), t.slice(0, 3));
                    },
                },
                filter: {
                    TAG: function (t) {
                            ...
                            : function (t, e, n) {
                                  ...
                                  if (u) {
                                      ...
                                      if (((l = [b ? u.firstChild : u.lastChild]), b && f)) {
                                          for (
                                              p = (a = (i = (o = (r = (s = u)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[d] || [])[0] === S && i[1]) && i[2], s = a && u.childNodes[a];
                                      ...
                                      } else if ((f && (p = a = (i = (o = (r = (s = t)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[d] || [])[0] === S && i[1]), !1 === p))
                                          for (
                                              ;
                                              (s = (++a && s && s[c]) || (p = a = 0) || l.pop()) &&
                                              ((y ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++p || (f && ((o = (r = s[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[d] = [S, p]), s !== t));
                    ...
                    PSEUDO: function (t, r) {
                        var e,
                            s = _.pseudos[t] || _.setFilters[t.toLowerCase()] || at.error("unsupported pseudo: " + t);
                        return s[T]
                            ? s(r)
                            : 1 < s.length
                            ? ((e = [t, t, "", r]),
                ...
                return (
                    ...
                    ct(function (t, e, n, i) {
                        var o,
                            ...
                            f = g ? (v || (t ? p : c || m) ? [] : e) : h;
                        if ((g && g(h, f, n, i), m)) for (o = xt(f, l), m(o, [], n, i), r = o.length; r--; ) (s = o[r]) && (f[l[r]] = !(h[l[r]] = s));
                        if (t) {
                            if (v || p) {
                                if (v) {
                                    for (o = [], r = f.length; r--; ) (s = f[r]) && o.push((h[r] = s));
                                    v(null, (f = []), o, i);
                                }
                ...
                for (
                    ...
                    if ((e = _.relative[t[a].type])) u = [_t(wt(u), e)];
                        ...
                        if ((e = _.filter[t[a].type].apply(null, t[a].matches))[T]) {
                            ...
                            return Ct(1 < a && wt(u), 1 < a && yt(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(z, "$1"), e, a < n && Et(t.slice(a, n)), n < i && Et((t = t.slice(n))), n < i && yt(t));
                        }
                        u.push(e);
                    }
                return wt(u);
            ...
            return (
                ...
                (d = at.tokenize = function (t, e) {
                    ...
                    for (s = t, a = [], l = _.preFilter; s; ) {
                        for (r in ((n && !(i = Y.exec(s))) || (i && (s = s.slice(i[0].length) || s), a.push((o = []))),
                        (n = !1),
                        (i = V.exec(s)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace(z, " ") }), (s = s.slice(n.length))),
                        _.filter))
                            !(i = $[r].exec(s)) || (l[r] && !(i = l[r](i))) || ((n = i.shift()), o.push({ value: n, type: r, matches: i }), (s = s.slice(n.length)));
                        if (!n) break;
                    }
                ...
                (f = at.compile = function (t, e) {
                    var n,
                        ...
                        r = I[t + " "];
                    if (!r) {
                        for (e || (e = d(t)), n = e.length; n--; ) (r = Et(e[n]))[T] ? i.push(r) : o.push(r);
                        (r = I(
                            t,
                            (function (m, v) {
                                function t(t, e, n, i, o) {
                                    ...
                                    for (o && (w = e === C || e || o); c !== g && null != (r = p[c]); c++) {
                                        if (y && r) {
                                            for (s = 0, e || r.ownerDocument === C || (x(r), (n = !E)); (a = m[s++]); )
                                                if (a(r, e || C, n)) {
                                                    i.push(r);
                                                    break;
                                                }
                ...
                (g = at.select = function (t, e, n, i) {
                    ...
                    if (((n = n || []), 1 === u.length)) {
                        if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === e.nodeType && E && _.relative[r[1].type]) {
                            if (!(e = (_.find.ID(s.matches[0].replace(it, h), e) || [])[0])) return n;
                            c && (e = e.parentNode), (t = t.slice(r.shift().value.length));
                        }
                        for (o = $.needsContext.test(t) ? 0 : r.length; o-- && ((s = r[o]), !_.relative[(a = s.type)]); )
                            if ((l = _.find[a]) && (i = l(s.matches[0].replace(it, h), (nt.test(r[0].type) && vt(e.parentNode)) || e))) {
                                if ((r.splice(o, 1), !(t = i.length && yt(r)))) return j.apply(n, i), n;
                                break;
                            }
                    }
        ...
        (T.filter = function (t, e, n) {
            ...
            T.fn.extend({
                ...
                is: function (t) {
                    return !!I(this, "string" == typeof t && S.test(t) ? T(t) : t || [], !1).length;
                },
            });
        var P,
            N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
        ((T.fn.init = function (t, e, n) {
            var i, o;
            if (!t) return this;
            if (((n = n || P), "string" != typeof t)) return t.nodeType ? ((this[0] = t), (this.length = 1), this) : y(t) ? (void 0 !== n.ready ? n.ready(t) : t(T)) : T.makeArray(t, this);
            if (!(i = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : N.exec(t)) || (!i[1] && e)) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
            if (i[1]) {
                if (((e = e instanceof T ? e[0] : e), T.merge(this, T.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : E, !0)), D.test(i[1]) && T.isPlainObject(e))) for (i in e) y(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this;
            }
            ...
            T.each(
                {
                    ...
                    contents: function (t) {
                        return void 0 !== t.contentDocument ? t.contentDocument : (k(t, "template") && (t = t.content || t), T.merge([], t.childNodes));
                    },
                },
                function (i, o) {
                    T.fn[i] = function (t, e) {
                        var n = T.map(this, o, t);
                        return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = T.filter(e, n)), 1 < this.length && (O[i] || T.uniqueSort(n), A.test(i) && n.reverse()), this.pushStack(n);
                    };
                }
            );
        var j = /[^\x20\t\r\n\f]+/g;
        ...
        (T.Callbacks = function (i) {
            i =
                "string" == typeof i
                    ...
                    : T.extend({}, i);
            function n() {
                for (r = r || i.once, e = o = !0; a.length; l = -1) for (t = a.shift(); ++l < s.length; ) !1 === s[l].apply(t[0], t[1]) && i.stopOnFalse && ((l = s.length), (t = !1));
            ...
            T.extend({
                        ...
                        s = {
                            ...
                            then: function (e, n, i) {
                                                ...
                                                (e = t && ("object" == typeof t || "function" == typeof t) && t.then),
                                                    y(e)
                                                        ? a
                                                            ...
                                                            : (l++, e.call(t, c(l, r, H, a), c(l, r, M, a), c(l, r, H, r.notifyWith)))
                                                        : (s !== H && ((n = void 0), (i = [t])), (a || r.resolveWith)(n, i));
                                            }
                                        }
                                        var n = this,
                                            i = arguments,
                                ...
                                return T.Deferred(function (t) {
                                    r[0][3].add(c(0, t, y(i) ? i : H, t.notifyWith)), r[1][3].add(c(0, t, y(e) ? e : H)), r[2][3].add(c(0, t, y(n) ? n : M));
                                }).promise();
                            },
                            promise: function (t) {
                ...
                when: function (t) {
                    ...
                    var n = arguments.length,
                        ...
                        r = a.call(arguments),
                        s = T.Deferred();
                    if (n <= 1 && (R(t, s.done(e(i)).resolve, s.reject, !n), "pending" === s.state() || y(r[i] && r[i].then))) return s.then();
        ...
        var W = T.Deferred();
        function F() {
            E.removeEventListener("DOMContentLoaded", F), C.removeEventListener("load", F), T.ready();
        }
        (T.fn.ready = function (t) {
            ...
            T.extend({
                ...
                readyWait: 1,
                ready: function (t) {
                    (!0 === t ? --T.readyWait : T.isReady) || ((T.isReady = !0) !== t && 0 < --T.readyWait) || W.resolveWith(E, [T]);
                },
            }),
            (T.ready.then = W.then),
            "complete" === E.readyState || ("loading" !== E.readyState && !E.documentElement.doScroll) ? C.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", F), C.addEventListener("load", F));
        var B = function (t, e, n, i, o, r, s) {
                var a = 0,
                    l = t.length,
                    c = null == n;
                if ("object" === w(n)) for (a in ((o = !0), n)) B(t, e, a, n[a], !0, r, s);
                else if (
                    void 0 !== i &&
                    ((o = !0),
                    y(i) || (s = !0),
            ...
            T.fn.extend({
                data: function (n, t) {
                    ...
                    if (void 0 !== n)
                        return "object" == typeof n
                            ...
                            : B(
                                  ...
                                  function (t) {
                                      var e;
                                      if (r && void 0 === t) return void 0 !== (e = $.get(r, n)) ? e : void 0 !== (e = Z(r, n)) ? e : void 0;
                                      this.each(function () {
                                          $.set(this, n, t);
                                      });
                                  },
                    ...
                    if (this.length && ((o = $.get(r)), 1 === r.nodeType && !Q.get(r, "hasDataAttrs"))) {
                        for (e = s.length; e--; ) s[e] && 0 === (i = s[e].name).indexOf("data-") && ((i = V(i.slice(5))), Z(r, i, o[i]));
                        ...
                        ? ("none" === n && ((c[u] = Q.get(i, "display") || null), c[u] || (i.style.display = "")),
                          "" === i.style.display &&
                              ...
                              (c[u] =
                                  ...
                                  (s = (o = i).ownerDocument),
                                  (a = o.nodeName),
                                  (l = ct[a]) || ((r = s.body.appendChild(s.createElement(a))), (l = T.css(r, "display")), r.parentNode.removeChild(r), "none" === l && (l = "block"), (ct[a] = l)))))
        ...
        function gt(t, e) {
            var n;
            return (n = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : []), void 0 === e || (e && k(t, e)) ? T.merge([t], n) : n;
        }
        function mt(t, e) {
            ...
            for (var r, s, a, l, c, u, h = e.createDocumentFragment(), f = [], p = 0, d = t.length; p < d; p++)
                if ((r = t[p]) || 0 === r)
                    if ("object" === w(r)) T.merge(f, r.nodeType ? [r] : r);
                        ...
                        for (s = s || h.appendChild(e.createElement("div")), a = (ft.exec(r) || ["", ""])[1].toLowerCase(), l = dt[a] || dt._default, s.innerHTML = l[1] + T.htmlPrefilter(r) + l[2], u = l[0]; u--; ) s = s.lastChild;
                        T.merge(f, s.childNodes), ((s = h.firstChild).textContent = "");
                    } else f.push(e.createTextNode(r));
            for (h.textContent = "", p = 0; (r = f[p++]); )
                if (i && -1 < T.inArray(r, i)) o && o.push(r);
                else if (((c = ot(r)), (s = gt(h.appendChild(r), "script")), c && mt(s), n)) for (u = 0; (r = s[u++]); ) pt.test(r.type || "") && n.push(r);
            return h;
        }
                  ...
                  T.event.add(t, o, {
                      ...
                      handler: function (t) {
                          ...
                          if (1 & t.isTrigger && this[o]) {
                              ...
                              else if (((i = a.call(arguments)), Q.set(this, o, i), (e = r(this, o)), this[o](), i !== (n = Q.get(this, o)) || e ? Q.set(this, o, !1) : (n = {}), i !== n))
                                  return t.stopImmediatePropagation(), t.preventDefault(), n.value;
                          } else i.length && (Q.set(this, o, { value: T.event.trigger(T.extend(i[0], T.Event.prototype), i.slice(1), this) }), t.stopImmediatePropagation());
                      },
                  }))
        ...
        (T.event = {
                    ...
                    for (
                        ...
                        (p = g = (a = Ct.exec(t[c]) || [])[1]),
                            ...
                            p &&
                                ...
                                (h = T.event.special[p] || {}),
                                (u = T.extend({ type: p, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && T.expr.match.needsContext.test(o), namespace: d.join(".") }, r)),
                                (f = l[p]) || (((f = l[p] = []).delegateCount = 0), (h.setup && !1 !== h.setup.call(e, i, d, s)) || (e.addEventListener && e.addEventListener(p, s))),
            ...
            remove: function (t, e, n, i, o) {
                ...
                if (m && (l = m.events)) {
                    for (c = (e = (e || "").match(j) || [""]).length; c--; )
                        if (((p = g = (a = Ct.exec(e[c]) || [])[1]), (d = (a[2] || "").split(".").sort()), p)) {
                            for (h = T.event.special[p] || {}, f = l[(p = (i ? h.delegateType : h.bindType) || p)] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--; )
                                (u = f[r]),
                                    (!o && g !== u.origType) ||
                                        (n && n.guid !== u.guid) ||
                                        (a && !a.test(u.namespace)) ||
                                        (i && i !== u.selector && ("**" !== i || !u.selector)) ||
                                        (f.splice(r, 1), u.selector && f.delegateCount--, h.remove && h.remove.call(t, u));
                            s && !f.length && ((h.teardown && !1 !== h.teardown.call(t, d, m.handle)) || T.removeEvent(t, p, m.handle), delete l[p]);
            ...
            special: {
                ...
                click: {
                    setup: function (t) {
                        var e = this || t;
                        return ht.test(e.type) && e.click && k(e, "input") && Dt(e, "click", Et), !1;
                    },
                    trigger: function (t) {
                        var e = this || t;
                        return ht.test(e.type) && e.click && k(e, "input") && Dt(e, "click"), !0;
                    },
                    _default: function (t) {
                        var e = t.target;
                        return (ht.test(e.type) && e.click && k(e, "input") && Q.get(e, "click")) || k(e, "a");
                    },
                },
                beforeunload: {
            ...
            (T.Event = function (t, e) {
                ...
                t && t.type
                    ? ((this.originalEvent = t),
                      (this.type = t.type),
                      (this.isDefaultPrevented = t.defaultPrevented || (void 0 === t.defaultPrevented && !1 === t.returnValue) ? Et : Tt),
        ...
        var It = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
            ...
            At = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
        function Ot(t, e) {
            return (k(t, "table") && k(11 !== e.nodeType ? e : e.firstChild, "tr") && T(t).children("tbody")[0]) || t;
        }
        function Lt(t) {
        ...
        function Ht(t, e) {
            var n, i, o, r, s, a, l, c;
            if (1 === e.nodeType) {
                if (Q.hasData(t) && ((r = Q.access(t)), (s = Q.set(e, r)), (c = r.events))) for (o in (delete s.handle, (s.events = {}), c)) for (n = 0, i = c[o].length; n < i; n++) T.event.add(e, o, c[o][n]);
                $.hasData(t) && ((a = $.access(t)), (l = T.extend({}, a)), $.set(e, l));
            }
        }
        function Mt(n, i, o, r) {
            i = m.apply([], i);
            var t,
                ...
                p = i[0],
                d = y(p);
            if (d || (1 < h && "string" == typeof p && !b.checkClone && Nt.test(p)))
                return n.each(function (t) {
                    var e = n.eq(t);
                    d && (i[0] = p.call(this, t, e.html())), Mt(e, i, o, r);
                });
            if (h && ((e = (t = _t(i, n[0].ownerDocument, !1, n, r)).firstChild), 1 === t.childNodes.length && (t = e), e || r)) {
                for (a = (s = T.map(gt(t, "script"), Lt)).length; u < h; u++) (l = t), u !== f && ((l = T.clone(l, !0, !0)), a && T.merge(s, gt(l, "script"))), o.call(n[u], l, u);
                if (a)
                    for (c = s[s.length - 1].ownerDocument, T.map(s, jt), u = 0; u < a; u++)
                        (l = s[u]),
                            pt.test(l.type || "") &&
                                !Q.access(l, "globalEval") &&
                                T.contains(c, l) &&
                                (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }) : _(l.textContent.replace(At, ""), l, c));
            }
            return n;
        }
        function Rt(t, e, n) {
            for (var i, o = e ? T.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || T.cleanData(gt(i)), i.parentNode && (n && ot(i) && mt(gt(i, "script")), i.parentNode.removeChild(i));
            return t;
        }
        T.extend({
            ...
            clone: function (t, e, n) {
                ...
                if (!(b.noCloneChecked || (1 !== t.nodeType && 11 !== t.nodeType) || T.isXMLDoc(t)))
                    for (s = gt(u), i = 0, o = (r = gt(t)).length; i < o; i++)
                        (a = r[i]), (l = s[i]), void 0, "input" === (c = l.nodeName.toLowerCase()) && ht.test(a.type) ? (l.checked = a.checked) : ("input" !== c && "textarea" !== c) || (l.defaultValue = a.defaultValue);
                if (e)
                    if (n) for (r = r || gt(t), s = s || gt(u), i = 0, o = r.length; i < o; i++) Ht(r[i], s[i]);
                    else Ht(t, u);
                ...
                html: function (t) {
                    return B(
                        ...
                        function (t) {
                            ...
                            if ("string" == typeof t && !Pt.test(t) && !dt[(ft.exec(t) || ["", ""])[1].toLowerCase()]) {
                                t = T.htmlPrefilter(t);
                                try {
                ...
                replaceWith: function () {
                    ...
                    return Mt(
                        ...
                        function (t) {
                            ...
                            T.inArray(this, n) < 0 && (T.cleanData(gt(this)), e && e.replaceChild(t, this));
                        },
                        n
                    );
                },
        ...
        function Gt(t, e, n) {
            ...
            return (
                (n = n || Kt(t)) &&
                    ("" !== (s = n.getPropertyValue(e) || n[e]) || ot(t) || (s = T.style(t, e)),
                    !b.pixelBoxStyles() && Vt.test(s) && Xt.test(e) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r))),
                void 0 !== s ? s + "" : s
            );
        }
        function Jt(t, e) {
        ...
        function le(t, e, n, i, o, r) {
            ...
            for (; s < 4; s += 2)
                "margin" === n && (l += T.css(t, n + nt[s], !0, o)),
                    i
                        ? ("content" === n && (l -= T.css(t, "padding" + nt[s], !0, o)), "margin" !== n && (l -= T.css(t, "border" + nt[s] + "Width", !0, o)))
                        : ((l += T.css(t, "padding" + nt[s], !0, o)), "padding" !== n ? (l += T.css(t, "border" + nt[s] + "Width", !0, o)) : (a += T.css(t, "border" + nt[s] + "Width", !0, o)));
            return !i && 0 <= r && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - r - l - a - 0.5)) || 0), l;
        }
        function ce(t, e, n) {
            var i = Kt(t),
            ...
            return (
                ((!b.boxSizingReliable() && o) || "auto" === s || (!parseFloat(s) && "inline" === T.css(t, "display", !1, i))) &&
                    t.getClientRects().length &&
                    ((o = "border-box" === T.css(t, "boxSizing", !1, i)), (r = a in t) && (s = t[a])),
                (s = parseFloat(s) || 0) + le(t, e, n || (o ? "border" : "content"), r, i, s) + "px"
            );
        }
        ...
        T.extend({
            ...
            style: function (t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    "string" === (r = typeof n) && (o = et.exec(n)) && o[1] && ((n = lt(t, e, o)), (r = "number")),
                        null != n &&
                            n == n &&
                ...
                T.cssHooks[l] = {
                    ...
                    set: function (t, e, n) {
                        var i,
                            ...
                            a = n ? le(t, l, n, s, o) : 0;
                        return (
                            s && r && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - le(t, l, "border", !1, o) - 0.5)),
                            a && (i = et.exec(e)) && "px" !== (i[3] || "px") && ((t.style[l] = e), (e = T.css(t, l))),
                            ae(0, e, a)
                        );
                    },
                };
        ...
        var he,
            ...
            me = /queueHooks$/;
        function ve() {
            fe && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(ve) : C.setTimeout(ve, T.fx.interval), T.fx.tick());
        }
        function be() {
            return (
                C.setTimeout(function () {
        ...
        function we(r, t, e) {
            var n,
                ...
                l = function () {
                    if (s) return !1;
                    for (var t = he || be(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, o = c.tweens.length; i < o; i++) c.tweens[i].run(n);
            ...
            for (
                !(function (t, e) {
                    var n, i, o, r, s;
                    for (n in t)
                        if (((o = e[(i = V(n))]), (r = t[n]), Array.isArray(r) && ((o = r[1]), (r = t[n] = r[0])), n !== i && ((t[i] = r), delete t[n]), (s = T.cssHooks[i]) && ("expand" in s)))
                ...
                if ((n = we.prefilters[i].call(c, r, u, c.opts))) return y(n.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
            return (
                T.map(u, _e, c),
        ...
        (T.Animation = T.extend(we, {
            ...
            tweener: function (t, e) {
                for (var n, i = 0, o = (t = y(t) ? ((e = t), ["*"]) : t.match(j)).length; i < o; i++) (n = t[i]), (we.tweeners[n] = we.tweeners[n] || []), we.tweeners[n].unshift(e);
            },
            prefilters: [
                function (t, e, n) {
                    var i,
                    ...
                    if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(p))
                        for (i in (h &&
                            ...
                            "none" === (u = T.css(t, "display")) && (c ? (u = c) : (ut([t], !0), (c = t.style.display || c), (u = T.css(t, "display")), ut([t]))),
                        ...
                        p))
                            l ||
                                ...
                                g && ut([t], !0),
                                f.done(function () {
                                    for (i in (g || ut([t]), Q.remove(t, "fxshow"), p)) T.style(t, i, p[i]);
                                })),
                                (l = _e(g ? m[i] : 0, i, f)),
            ...
            (T.speed = function (t, e, n) {
                var i = t && "object" == typeof t ? T.extend({}, t) : { complete: n || (!n && e) || (y(t) && t), duration: t, easing: (n && e) || (e && !y(e) && e) };
                return (
            ...
            T.each({ slideDown: ye("show"), slideUp: ye("hide"), slideToggle: ye("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, i) {
            ...
            (de = E.createElement("select").appendChild(E.createElement("option"))),
            (pe.type = "checkbox"),
            (b.checkOn = "" !== pe.value),
                ...
                attr: function (t, e, n) {
                    ...
                    if (3 !== r && 8 !== r && 2 !== r)
                        return void 0 === t.getAttribute
                            ? T.prop(t, e, n)
                            : ((1 === r && T.isXMLDoc(t)) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? xe : void 0)),
                              void 0 !== n
                                  ? null === n
            ...
            T.fn.extend({
                ...
                toggleClass: function (o, e) {
                    ...
                    return "boolean" == typeof e && s
                        ...
                        : this.each(function () {
                              var t, e, n, i;
                              if (s) for (e = 0, n = T(this), i = De(o); (t = i[e++]); ) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
                              else (void 0 !== o && "boolean" != r) || ((t = ke(this)) && Q.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : Q.get(this, "__className__") || ""));
                          });
                },
                hasClass: function (t) {
                    var e,
                        n,
                        i = 0;
                    for (e = " " + t + " "; (n = this[i++]); ) if (1 === n.nodeType && -1 < (" " + Se(ke(n)) + " ").indexOf(e)) return !0;
                    return !1;
                },
            });
        var Ie = /\r/g;
        ...
        T.extend(T.event, {
            trigger: function (t, e, n, i) {
                ...
                if (
                    ...
                    if (!i && !u.noBubble && !g(n)) {
                        for (a = u.delegateType || p, Ne.test(a + p) || (r = r.parentNode); r; r = r.parentNode) f.push(r), (s = r);
        ...
        function qe(n, t, i, o) {
            ...
            if (Array.isArray(t))
                T.each(t, function (t, e) {
                    i || je.test(n) ? o(n, e) : qe(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, o);
                });
            ...
            T.fn.extend({
                ...
                serializeArray: function () {
                    return this.map(function () {
                        ...
                        .filter(function () {
                            var t = this.type;
                            return this.name && !T(this).is(":disabled") && Re.test(this.nodeName) && !Me.test(t) && (this.checked || !ht.test(t));
                        })
                        .map(function (t, e) {
                            var n = T(this).val();
                            return null == n
        ...
        function $e(r) {
            return function (t, e) {
                ...
                if (y(e)) for (; (n = o[i++]); ) "+" === n[0] ? ((n = n.slice(1) || "*"), (r[n] = r[n] || []).unshift(e)) : (r[n] = r[n] || []).push(e);
            };
        }
        function Ge(e, o, r, s) {
            var a = {},
        ...
        (Qe.href = Ae.href),
            T.extend({
                ...
                ajax: function (t, e) {
                    ...
                    var u,
                        ...
                        x = {
                            ...
                            getResponseHeader: function (t) {
                                var e;
                                if (d) {
                                    if (!n) for (n = {}; (e = Ue.exec(f)); ) n[e[1].toLowerCase() + " "] = (n[e[1].toLowerCase() + " "] || []).concat(e[2]);
                                    e = n[t.toLowerCase() + " "];
                                }
                    ...
                    if (
                        (y.promise(x),
                        (m.url = ((t || m.url || Ae.href) + "").replace(Ye, Ae.protocol + "//")),
                    ...
                    if ((m.data && m.processData && "string" != typeof m.data && (m.data = T.param(m.data, m.traditional)), Ge(Ve, m, e, x), d)) return x;
                    ...
                    m.hasContent
                        ...
                        : ((r = m.url.slice(h.length)),
                          ...
                          !1 === m.cache && ((h = h.replace(Be, "$1")), (r = (Le.test(h) ? "&" : "?") + "_=" + Oe++ + r)),
                          (m.url = h + r)),
                    m.ifModified && (T.lastModified[h] && x.setRequestHeader("If-Modified-Since", T.lastModified[h]), T.etag[h] && x.setRequestHeader("If-None-Match", T.etag[h])),
                    ...
                    if (m.beforeSend && (!1 === m.beforeSend.call(v, x, m) || d)) return x.abort();
                    if (((l = "abort"), _.add(m.complete), x.done(m.success), x.fail(m.error), (u = Ge(Ke, m, e, x)))) {
                        if (((x.readyState = 1), g && b.trigger("ajaxSend", [x, m]), d)) return x;
                        m.async &&
                            0 < m.timeout &&
                    ...
                    function c(t, e, n, i) {
                        ...
                        d ||
                            ...
                            o
                                ? (m.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (T.lastModified[h] = l), (l = x.getResponseHeader("etag")) && (T.etag[h] = l)),
        ...
        T.ajaxSetup({
            ...
            T.ajaxPrefilter("json jsonp", function (t, e, n) {
                ...
                if (s || "jsonp" === t.dataTypes[0])
                    return (
                        ...
                        s ? (t[s] = t[s].replace(on, "$1" + i)) : !1 !== t.jsonp && (t.url += (Le.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
                        ...
                        n.always(function () {
                            void 0 === o ? T(C).removeProp(i) : (C[i] = o), t[i] && ((t.jsonpCallback = e.jsonpCallback), nn.push(i)), r && y(o) && o(r[0]), (r = o = void 0);
                        }),
                        "script"
                    );
            }),
            (b.createHTMLDocument = (((en = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === en.childNodes.length)),
            (T.parseHTML = function (t, e, n) {
                return "string" != typeof t
                    ? []
                    : ("boolean" == typeof e && ((n = e), (e = !1)),
                      e || (b.createHTMLDocument ? (((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href), e.head.appendChild(i)) : (e = E)),
                      (r = !n && []),
                      (o = D.exec(t)) ? [e.createElement(o[1])] : ((o = _t([t], e, r)), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
                var i, o, r;
            }),
            ...
            T.each(["top", "left"], function (t, n) {
                T.cssHooks[n] = Jt(b.pixelPosition, function (t, e) {
                    if (e) return (e = Gt(t, n)), Vt.test(e) ? T(t).position()[n] + "px" : e;
                });
            }),
        ...
        return (
            (T.noConflict = function (t) {
                return C.$ === T && (C.$ = sn), t && C.jQuery === T && (C.jQuery = rn), T;
            }),
            t || (C.jQuery = C.$ = T),
            T
        );
    ...
    (function (t) {
        ...
        function o(t, e) {
            ...
            return "area" === r
                ? ((i = (n = t.parentNode).name), !(!t.href || !i || "map" !== n.nodeName.toLowerCase()) && !!(o = y("img[usemap='#" + i + "']")[0]) && s(o))
                : (/^(input|select|textarea|button|object)$/.test(r) ? !t.disabled : ("a" === r && t.href) || e) && s(t);
        }
        function s(t) {
            return (
        ...
        (y.ui = y.ui || {}),
            ...
            y("<a>").outerWidth(1).jquery ||
                y.each(["Width", "Height"], function (t, n) {
                    var o = "Width" === n ? ["Left", "Right"] : ["Top", "Bottom"],
                        i = n.toLowerCase(),
                        r = { innerWidth: y.fn.innerWidth, innerHeight: y.fn.innerHeight, outerWidth: y.fn.outerWidth, outerHeight: y.fn.outerHeight };
                    function s(t, e, n, i) {
                        return (
                            y.each(o, function () {
                                (e -= parseFloat(y.css(t, "padding" + this)) || 0), n && (e -= parseFloat(y.css(t, "border" + this + "Width")) || 0), i && (e -= parseFloat(y.css(t, "margin" + this)) || 0);
                            }),
                            e
                        );
                    }
            ...
            y("<a>").data("a-b", "a").removeData("a-b").data("a-b") &&
                (y.fn.removeData =
                    ((e = y.fn.removeData),
                    function (t) {
            ...
            (y.ui.plugin = {
                add: function (t, e, n) {
                    var i,
                        o = y.ui[t].prototype;
                    for (i in n) (o.plugins[i] = o.plugins[i] || []), o.plugins[i].push([e, n[i]]);
                },
        ...
        (y.cleanData =
            ...
            (y.widget = function (t, n, e) {
                ...
                return (
                    ...
                    y.extend(r, o, { version: e.version, _proto: y.extend({}, e), _childConstructors: [] }),
                    ...
                    (r.prototype = y.widget.extend(s, { widgetEventPrefix: (o && s.widgetEventPrefix) || t }, a, { constructor: r, namespace: l, widgetName: t, widgetFullName: i })),
                    o
            ...
            (y.widget.extend = function (t) {
                for (var e, n, i = l.call(arguments, 1), o = 0, r = i.length; o < r; o++)
                    for (e in i[o]) (n = i[o][e]), i[o].hasOwnProperty(e) && void 0 !== n && (y.isPlainObject(n) ? (t[e] = y.isPlainObject(t[e]) ? y.widget.extend({}, t[e], n) : y.widget.extend({}, n)) : (t[e] = n));
                return t;
            }),
                                  ...
                                  return "instance" === n
                                      ...
                                      ? y.isFunction(e[n]) && "_" !== n.charAt(0)
                                          ? (t = e[n].apply(e, i)) !== e && void 0 !== t
                                              ...
                                              : void 0
                                          : y.error("no such method '" + n + "' for " + r + " widget instance")
                                      : y.error("cannot call methods on " + r + " prior to initialization; attempted to call method '" + n + "'");
                              })
                            : (i.length && (n = y.widget.extend.apply(null, [n].concat(i))),
                              this.each(function () {
                                  var t = y.data(this, s);
                                  t ? (t.option(n || {}), t._init && t._init()) : y.data(this, s, new e(n, this));
                              })),
                        o
                    );
                };
            ...
            (y.Widget.prototype = {
                ...
                option: function (t, e) {
                    ...
                    if ("string" == typeof t)
                        if (((r = {}), (t = (n = t.split(".")).shift()), n.length)) {
                            for (i = r[t] = y.widget.extend({}, this.options[t]), o = 0; o < n.length - 1; o++) (i[n[o]] = i[n[o]] || {}), (i = i[n[o]]);
                ...
                _on: function (s, a, t) {
                    ...
                    "boolean" != typeof s && ((t = a), (a = s), (s = !1)),
                        t ? ((a = l = y(a)), (this.bindings = this.bindings.add(a))) : ((t = a), (a = this.element), (l = this.widget())),
                        y.each(t, function (t, e) {
                            function n() {
                                if (s || (!0 !== c.options.disabled && !y(this).hasClass("ui-state-disabled"))) return ("string" == typeof e ? c[e] : e).apply(c, arguments);
                            }
                ...
                _trigger: function (t, e, n) {
                    var i,
                        o,
                        r = this.options[t];
                    if (((n = n || {}), ((e = y.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase()), (e.target = this.element[0]), (o = e.originalEvent))) for (i in o) i in e || (e[i] = o[i]);
                    return this.element.trigger(e, n), !((y.isFunction(r) && !1 === r.apply(this.element[0], [e].concat(n))) || e.isDefaultPrevented());
                },
            }),
            y.each({ show: "fadeIn", hide: "fadeOut" }, function (r, s) {
                y.Widget.prototype["_" + r] = function (e, t, n) {
                    "string" == typeof t && (t = { effect: t });
                    var i,
                        o = t ? (!0 === t || "number" == typeof t ? s : t.effect || s) : r;
        ...
        y.widget("ui.draggable", y.ui.mouse, {
            ...
            _mouseCapture: function (t) {
                ...
                return (
                    ...
                    !(this.helper || e.disabled || 0 < y(t.target).closest(".ui-resizable-handle").length) && ((this.handle = this._getHandle(t)), !!this.handle && (this._blockFrames(!0 === e.iframeFix ? "iframe" : e.iframeFix), !0))
                );
            },
            ...
            _mouseStop: function (t) {
                var e = this,
                    n = !1;
                return (
                    y.ui.ddmanager && !this.options.dropBehaviour && (n = y.ui.ddmanager.drop(this, t)),
                    this.dropped && ((n = this.dropped), (this.dropped = !1)),
                    ("invalid" === this.options.revert && !n) || ("valid" === this.options.revert && n) || !0 === this.options.revert || (y.isFunction(this.options.revert) && this.options.revert.call(this.element, n))
            ...
            _mouseUp: function (t) {
                return this._unblockFrames(), y.ui.ddmanager && y.ui.ddmanager.dragStop(this, t), this.handleElement.is(t.target) && this.element.focus(), y.ui.mouse.prototype._mouseUp.call(this, t);
            },
            cancel: function () {
                                    ...
                                    ? ("parent" === i.containment && (i.containment = this.helper[0].parentNode),
                                      (n = (e = y(i.containment))[0]) &&
                                          ...
                                          (this.containment = [
                                              ...
                                              (t ? Math.max(n.scrollWidth, n.offsetWidth) : n.offsetWidth) -
                                                  (parseInt(e.css("borderRightWidth"), 10) || 0) -
                                                  (parseInt(e.css("paddingRight"), 10) || 0) -
                                                  this.helperProportions.width -
                                                  this.margins.left -
                                                  this.margins.right,
                                              (t ? Math.max(n.scrollHeight, n.offsetHeight) : n.offsetHeight) -
            ...
            _generatePosition: function (t, e) {
                ...
                return (
                    ...
                    e &&
                        (this.containment &&
                            ((n = this.relativeContainer ? ((i = this.relativeContainer.offset()), [this.containment[0] + i.left, this.containment[1] + i.top, this.containment[2] + i.left, this.containment[3] + i.top]) : this.containment),
                        ...
                        s.grid &&
                            ((o = s.grid[1] ? this.originalPageY + Math.round((c - this.originalPageY) / s.grid[1]) * s.grid[1] : this.originalPageY),
            ...
            y.ui.plugin.add("draggable", "connectToSortable", {
                start: function (e, t, n) {
                    var i = y.extend({}, t, { item: n.element });
                    (n.sortables = []),
                        y(n.options.connectToSortable).each(function () {
                            var t = y(this).sortable("instance");
                            t && !t.options.disabled && (n.sortables.push(t), t.refreshPositions(), t._trigger("activate", e, i));
                        });
                },
                stop: function (e, t, n) {
                    var i = y.extend({}, t, { item: n.element });
                        ...
                        (e.positionAbs = o.positionAbs),
                            ...
                            t
                                ? (e.isOver ||
                                      ...
                                      (e.fromOutside = o)),
                                  e.currentItem && (e._mouseDrag(n), (i.position = e.position)))
                                : e.isOver &&
                                  ((e.isOver = 0),
            ...
            y.ui.plugin.add("draggable", "scroll", {
                ...
                drag: function (t, e, n) {
                    ...
                    r !== s && "HTML" !== r.tagName
                        ? ((i.axis && "x" === i.axis) ||
                              (n.overflowOffset.top + r.offsetHeight - t.pageY < i.scrollSensitivity
                                  ? (r.scrollTop = o = r.scrollTop + i.scrollSpeed)
                                  : t.pageY - n.overflowOffset.top < i.scrollSensitivity && (r.scrollTop = o = r.scrollTop - i.scrollSpeed)),
                          (i.axis && "y" === i.axis) ||
                              (n.overflowOffset.left + r.offsetWidth - t.pageX < i.scrollSensitivity
                                  ? (r.scrollLeft = o = r.scrollLeft + i.scrollSpeed)
                                  : t.pageX - n.overflowOffset.left < i.scrollSensitivity && (r.scrollLeft = o = r.scrollLeft - i.scrollSpeed)))
                        : ((i.axis && "x" === i.axis) ||
                              (t.pageY - y(s).scrollTop() < i.scrollSensitivity
                                  ? (o = y(s).scrollTop(y(s).scrollTop() - i.scrollSpeed))
                                  : y(window).height() - (t.pageY - y(s).scrollTop()) < i.scrollSensitivity && (o = y(s).scrollTop(y(s).scrollTop() + i.scrollSpeed))),
                          (i.axis && "y" === i.axis) ||
                              (t.pageX - y(s).scrollLeft() < i.scrollSensitivity
                                  ? (o = y(s).scrollLeft(y(s).scrollLeft() - i.scrollSpeed))
                                  : y(window).width() - (t.pageX - y(s).scrollLeft()) < i.scrollSensitivity && (o = y(s).scrollLeft(y(s).scrollLeft() + i.scrollSpeed)))),
                ...
                start: function (t, e, n) {
                    ...
                    (n.snapElements = []),
                        y(i.snap.constructor !== String ? i.snap.items || ":data(ui-draggable)" : i.snap).each(function () {
                            var t = y(this),
                                e = t.offset();
                            this !== n.element[0] && n.snapElements.push({ item: this, width: t.outerWidth(), height: t.outerHeight(), top: e.top, left: e.left });
                        });
                },
                drag: function (t, e, n) {
                    var i,
                    ...
                    for (h = n.snapElements.length - 1; 0 <= h; h--)
                        (l = (a = n.snapElements[h].left - n.margins.left) + n.snapElements[h].width),
                            ...
                            m < a - d || l + d < g || b < c - d || u + d < v || !y.contains(n.snapElements[h].item.ownerDocument, n.snapElements[h].item)
                                ? (n.snapElements[h].snapping && n.options.snap.release && n.options.snap.release.call(n.element, t, y.extend(n._uiHash(), { snapItem: n.snapElements[h].item })), (n.snapElements[h].snapping = !1))
                                : ("inner" !== p.snapMode &&
                                      ((i = Math.abs(c - b) <= d),
                                      (o = Math.abs(u - v) <= d),
                                      (r = Math.abs(a - m) <= d),
                                      (s = Math.abs(l - g) <= d),
                                      i && (e.position.top = n._convertPositionTo("relative", { top: c - n.helperProportions.height, left: 0 }).top),
                                      o && (e.position.top = n._convertPositionTo("relative", { top: u, left: 0 }).top),
                                      r && (e.position.left = n._convertPositionTo("relative", { top: 0, left: a - n.helperProportions.width }).left),
                                      s && (e.position.left = n._convertPositionTo("relative", { top: 0, left: l }).left)),
                                  (f = i || o || r || s),
                                  "outer" !== p.snapMode &&
                                      ((i = Math.abs(c - v) <= d),
                                      (o = Math.abs(u - b) <= d),
                                      (r = Math.abs(a - g) <= d),
                                      (s = Math.abs(l - m) <= d),
                                      i && (e.position.top = n._convertPositionTo("relative", { top: c, left: 0 }).top),
                                      o && (e.position.top = n._convertPositionTo("relative", { top: u - n.helperProportions.height, left: 0 }).top),
                                      r && (e.position.left = n._convertPositionTo("relative", { top: 0, left: a }).left),
                                      s && (e.position.left = n._convertPositionTo("relative", { top: 0, left: l - n.helperProportions.width }).left)),
                                  !n.snapElements[h].snapping && (i || o || r || s || f) && n.options.snap.snap && n.options.snap.snap.call(n.element, t, y.extend(n._uiHash(), { snapItem: n.snapElements[h].item })),
                    ...
                    (this.element
                        ...
                        .each(function () {
                            ...
                            if (
                                ...
                                y.ui.intersect(n, y.extend(t, { offset: t.element.offset() }), t.options.tolerance, e)
                            )
                                return !(i = !0);
                        }),
                    !i &&
            ...
            (y.ui.ddmanager = {
                ...
                prepareOffsets: function (t, e) {
                    var n,
                        ...
                        r = e ? e.type : null,
                        s = (t.currentItem || t.element).find(":data(ui-droppable)").addBack();
                    t: for (n = 0; n < o.length; n++)
                        if (!(o[n].options.disabled || (t && !o[n].accept.call(o[n].element[0], t.currentItem || t.element)))) {
                            ...
                            (o[n].visible = "none" !== o[n].element.css("display")),
                                o[n].visible && ("mousedown" === r && o[n]._activate.call(o[n], e), (o[n].offset = o[n].element.offset()), o[n].proportions({ width: o[n].element[0].offsetWidth, height: o[n].element[0].offsetHeight }));
                        }
                },
                drop: function (t, e) {
                    var n = !1;
                    return (
                        y.each((y.ui.ddmanager.droppables[t.options.scope] || []).slice(), function () {
                            this.options &&
                                (!this.options.disabled && this.visible && y.ui.intersect(t, this, this.options.tolerance, e) && (n = this._drop.call(this, e) || n),
                        ...
                        y.each(y.ui.ddmanager.droppables[r.options.scope] || [], function () {
                            if (!this.options.disabled && !this.greedyChild && this.visible) {
                                ...
                                o &&
                                    ...
                                    t && "isover" === o && ((t.isover = !1), (t.isout = !0), t._out.call(t, s)),
                                    (this[o] = !0),
                                    (this["isout" === o ? "isover" : "isout"] = !1),
                                    this["isover" === o ? "_over" : "_out"].call(this, s),
                                    t && "isout" === o && ((t.isout = !1), (t.isover = !0), t._over.call(t, s)));
                            }
                        });
                },
                dragStop: function (t, e) {
                    t.element.parentsUntil("body").unbind("scroll.droppable"), t.options.refreshPositions || y.ui.ddmanager.prepareOffsets(t, e);
                },
            });
        y.ui.droppable,
            y.widget("ui.sortable", y.ui.mouse, {
                ...
                _mouseCapture: function (t, e) {
                    ...
                    return (
                        ...
                        y(t.target)
                            .parents()
                            .each(function () {
                                if (y.data(this, o.widgetName + "-item") === o) return (n = y(this)), !1;
                            }),
                ...
                _mouseStart: function (t, e, n) {
                    ...
                    if (
                        ...
                        y.extend(this.offset, { click: { left: t.pageX - this.offset.left, top: t.pageY - this.offset.top }, parent: this._getParentOffset(), relative: this._getRelativeOffset() }),
                        ...
                        r.cursor &&
                            "auto" !== r.cursor &&
                            ((o = this.document.find("body")), (this.storedCursor = o.css("cursor")), o.css("cursor", r.cursor), (this.storedStylesheet = y("<style>*{ cursor: " + r.cursor + " !important; }</style>").appendTo(o))),
                        ...
                        for (i = this.containers.length - 1; 0 <= i; i--) this.containers[i]._trigger("activate", t, this._uiHash(this));
                    return (
                        y.ui.ddmanager && (y.ui.ddmanager.current = this),
                    ...
                    for (
                            ...
                            this.options.scroll &&
                                (this.scrollParent[0] !== this.document[0] && "HTML" !== this.scrollParent[0].tagName
                                    ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < r.scrollSensitivity
                                          ? (this.scrollParent[0].scrollTop = s = this.scrollParent[0].scrollTop + r.scrollSpeed)
                                          : t.pageY - this.overflowOffset.top < r.scrollSensitivity && (this.scrollParent[0].scrollTop = s = this.scrollParent[0].scrollTop - r.scrollSpeed),
                                      this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < r.scrollSensitivity
                                          ? (this.scrollParent[0].scrollLeft = s = this.scrollParent[0].scrollLeft + r.scrollSpeed)
                                          : t.pageX - this.overflowOffset.left < r.scrollSensitivity && (this.scrollParent[0].scrollLeft = s = this.scrollParent[0].scrollLeft - r.scrollSpeed))
                                    : (t.pageY - this.document.scrollTop() < r.scrollSensitivity
                                          ? (s = this.document.scrollTop(this.document.scrollTop() - r.scrollSpeed))
                                          : this.window.height() - (t.pageY - this.document.scrollTop()) < r.scrollSensitivity && (s = this.document.scrollTop(this.document.scrollTop() + r.scrollSpeed)),
                                      t.pageX - this.document.scrollLeft() < r.scrollSensitivity
                                          ? (s = this.document.scrollLeft(this.document.scrollLeft() - r.scrollSpeed))
                                          : this.window.width() - (t.pageX - this.document.scrollLeft()) < r.scrollSensitivity && (s = this.document.scrollLeft(this.document.scrollLeft() + r.scrollSpeed))),
                        ...
                        if (
                            ...
                            (o = this._intersectsWithPointer(n)) &&
                                ...
                                !(i === this.currentItem[0] || this.placeholder[1 === o ? "next" : "prev"]()[0] === i || y.contains(this.placeholder[0], i) || ("semi-dynamic" === this.options.type && y.contains(this.element[0], i))))
                        ) {
                ...
                _mouseStop: function (t, e) {
                    if (t) {
                        if ((y.ui.ddmanager && !this.options.dropBehaviour && y.ui.ddmanager.drop(this, t), this.options.revert)) {
                            var n = this,
                ...
                cancel: function () {
                    ...
                    return (
                        this.placeholder &&
                            ...
                            y.extend(this, { helper: null, dragging: !1, reverting: !1, _noFinalSort: null }),
                ...
                _intersectsWith: function (t) {
                    ...
                    return "pointer" === this.options.tolerance ||
                        ...
                        ? p
                        : r < e + this.helperProportions.width / 2 && n - this.helperProportions.width / 2 < s && a < i + this.helperProportions.height / 2 && o - this.helperProportions.height / 2 < l;
                },
                        ...
                        for (e = a.length - 1; 0 <= e; e--)
                            for (n = (i = y(a[e], this.document[0])).length - 1; 0 <= n; n--)
                                (o = y.data(i[n], this.widgetFullName)) &&
                                    o !== this &&
                                    !o.options.disabled &&
                                    s.push([y.isFunction(o.options.items) ? o.options.items.call(o.element) : y(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
                    function l() {
                        r.push(this);
                    }
                    for (
                        s.push([
                            y.isFunction(this.options.items)
                                ...
                                : y(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
                            this,
                        ]),
                            e = s.length - 1;
                        0 <= e;
                ...
                _removeCurrentsFromItems: function () {
                    ...
                    this.items = y.grep(this.items, function (t) {
                        for (var e = 0; e < n.length; e++) if (n[e] === t.item[0]) return !1;
                        return !0;
                    });
                },
                _refreshItems: function (t) {
                    ...
                    var e,
                        ...
                        l,
                        c = this.items,
                        u = [[y.isFunction(this.options.items) ? this.options.items.call(this.element[0], t, { item: this.currentItem }) : y(this.options.items, this.element), this]],
                        h = this._connectWith();
                    if (h && this.ready)
                        for (e = h.length - 1; 0 <= e; e--)
                            for (n = (i = y(h[e], this.document[0])).length - 1; 0 <= n; n--)
                                (o = y.data(i[n], this.widgetFullName)) &&
                                    o !== this &&
                                    !o.options.disabled &&
                                    (u.push([y.isFunction(o.options.items) ? o.options.items.call(o.element[0], t, { item: this.currentItem }) : y(o.options.items, o.element), o]), this.containers.push(o));
                    for (e = u.length - 1; 0 <= e; e--) for (r = u[e][1], n = 0, l = (s = u[e][0]).length; n < l; n++) (a = y(s[n])).data(this.widgetName + "-item", r), c.push({ item: a, instance: r, width: 0, height: 0, left: 0, top: 0 });
                },
                refreshPositions: function (t) {
                    ...
                    for (
                        ...
                        ((n = this.items[e]).instance !== this.currentContainer && this.currentContainer && n.item[0] !== this.currentItem[0]) ||
                            ((i = this.options.toleranceElement ? y(this.options.toleranceElement, n.item) : n.item), t || ((n.width = i.outerWidth()), (n.height = i.outerHeight())), (o = i.offset()), (n.left = o.left), (n.top = o.top));
                        ...
                        (o.placeholder = {
                            element: function () {
                                var t = n.currentItem[0].nodeName.toLowerCase(),
                                    e = y("<" + t + ">", n.document[0])
                                        .addClass(i || n.currentItem[0].className + " ui-sortable-placeholder")
                                        .removeClass("ui-sortable-helper");
                                return (
                                    "tbody" === t
                                        ? n._createTrPlaceholder(n.currentItem.find("tr").eq(0), y("<tr>", n.document[0]).appendTo(e))
                                        : "tr" === t
                                        ? n._createTrPlaceholder(n.currentItem, e)
                                        : "img" === t && e.attr("src", n.currentItem.attr("src")),
                            ...
                            update: function (t, e) {
                                (i && !o.forcePlaceholderSize) ||
                                    (e.height() || e.height(n.currentItem.innerHeight() - parseInt(n.currentItem.css("paddingTop") || 0, 10) - parseInt(n.currentItem.css("paddingBottom") || 0, 10)),
                ...
                _contactContainers: function (t) {
                    ...
                    for (e = this.containers.length - 1; 0 <= e; e--)
                        if (!y.contains(this.currentItem[0], this.containers[e].element[0]))
                            if (this._intersectsWith(this.containers[e].containerCache)) {
                                if (h && y.contains(this.containers[e].element[0], h.element[0])) continue;
                    ...
                    if (h)
                        if (1 === this.containers.length) this.containers[f].containerCache.over || (this.containers[f]._trigger("over", t, this._uiHash(this)), (this.containers[f].containerCache.over = 1));
                            ...
                            for (i = 1e4, o = null, r = (c = h.floating || this._isFloating(this.currentItem)) ? "left" : "top", s = c ? "width" : "height", u = c ? "clientX" : "clientY", n = this.items.length - 1; 0 <= n; n--)
                                y.contains(this.containers[f].element[0], this.items[n].item[0]) &&
                                    this.items[n].item[0] !== this.currentItem[0] &&
                                    ((a = this.items[n].item.offset()[r]),
                                    (l = !1),
                                    t[u] - a > this.items[n][s] / 2 && (l = !0),
                                    Math.abs(t[u] - a) < i && ((i = Math.abs(t[u] - a)), (o = this.items[n]), (this.direction = l ? "up" : "down")));
                            if (!o && !this.options.dropOnEmpty) return;
                            if (this.currentContainer === this.containers[f])
                                return void (this.currentContainer.containerCache.over || (this.containers[f]._trigger("over", t, this._uiHash()), (this.currentContainer.containerCache.over = 1)));
                ...
                _createHelper: function (t) {
                    ...
                    return (
                        n.parents("body").length || y("parent" !== e.appendTo ? e.appendTo : this.currentItem[0].parentNode)[0].appendChild(n[0]),
                ...
                _getParentOffset: function () {
                    ...
                    return (
                        ...
                        (this.offsetParent[0] === this.document[0].body || (this.offsetParent[0].tagName && "html" === this.offsetParent[0].tagName.toLowerCase() && y.ui.ie)) && (t = { top: 0, left: 0 }),
                        { top: t.top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0), left: t.left + (parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0) }
                    );
                },
                _getRelativeOffset: function () {
                    ...
                    "parent" === i.containment && (i.containment = this.helper[0].parentNode),
                        ("document" !== i.containment && "window" !== i.containment) ||
                            (this.containment = [
                                ...
                                ("document" === i.containment ? this.document.width() : this.window.height() || this.document[0].body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top,
                            ]),
                        /^(document|window|parent)$/.test(i.containment) ||
                            ...
                            (this.containment = [
                                e.left + (parseInt(y(t).css("borderLeftWidth"), 10) || 0) + (parseInt(y(t).css("paddingLeft"), 10) || 0) - this.margins.left,
                                e.top + (parseInt(y(t).css("borderTopWidth"), 10) || 0) + (parseInt(y(t).css("paddingTop"), 10) || 0) - this.margins.top,
                                e.left +
                                    ...
                                    this.margins.left,
                                e.top +
                                    (n ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
                ...
                _clear: function (t, e) {
                    ...
                    for (
                        ...
                        e || i.push(o("deactivate", this, this.containers[n])), this.containers[n].containerCache.over && (i.push(o("out", this, this.containers[n])), (this.containers[n].containerCache.over = 0));
                    if (
                ...
                _uiHash: function (t) {
                    var e = t || this;
                    return { helper: e.helper, placeholder: e.placeholder || y([]), position: e.position, originalPosition: e.originalPosition, offset: e.positionAbs, item: e.currentItem, sender: t ? t.element : null };
                },
            });
        var u,
            h,
        ...
        function L(t, e, n) {
            var i = b[e.type] || {};
            return null == t ? (n || !e.def ? null : e.def) : ((t = i.floor ? ~~t : parseFloat(t)), isNaN(t) ? e.def : i.mod ? (t + i.mod) % i.mod : t < 0 ? 0 : i.max < t ? i.max : t);
        }
        function j(s) {
            var a = m(),
                l = (a._rgba = []);
            return (
                ...
                x(g, function (t, e) {
                    var n,
                        ...
                        o = i && e.parse(i),
                        r = e.space || "rgba";
                    if (o) return (n = a[r](o)), (a[v[r].cache] = n[v[r].cache]), (l = a._rgba = n._rgba), !1;
                }),
                l.length ? ("0,0,0,0" === l.join() && u.extend(l, p.transparent), a) : p[s]
            );
        }
        function H(t, e, n) {
        ...
        function M(t) {
            var e,
                ...
                o = {};
            if (i && i.length && i[0] && i[i[0]]) for (n = i.length; n--; ) "string" == typeof i[(e = i[n])] && (o[y.camelCase(e)] = i[e]);
        ...
        function R(t, e, n, i) {
            return (
                ...
                ("number" != typeof e && !y.fx.speeds[e]) || ((i = n), (n = e), (e = {})),
        ...
        (y.effects = { effect: {} }),
            ...
            (b = { byte: { floor: !0, max: 255 }, percent: { max: 1 }, degrees: { mod: 360, floor: !0 } }),
            (_ = m.support = {}),
            (w = u("<p>")[0]),
            (x = u.each),
                            ...
                            return (
                                i &&
                                    ...
                                    x(e.props, function (t, e) {
                                        if (null != i[e.idx]) return (r = i[e.idx] === n[e.idx]);
                                    })),
                                r
                            );
                        }),
                    ...
                    return (
                        ...
                        x(n.props, function (t, e) {
                            var n = e.idx,
                                ...
                                o = a[n],
                                r = b[e.type] || {};
                            null !== o && (null === i ? (c[n] = o) : (r.mod && (o - i > r.mod / 2 ? (i += r.mod) : i - o > r.mod / 2 && (i -= r.mod)), (c[n] = L((o - i) * s + i, e))));
                        }),
                        this[e](c)
                    );
                },
            ...
            (v.hsla.to = function (t) {
                ...
                var e,
                    ...
                    h = 0.5 * u;
                return (
                    (e = l === a ? 0 : i === a ? (60 * (o - r)) / c + 360 : o === a ? (60 * (r - i)) / c + 120 : (60 * (i - o)) / c + 240), (n = 0 == c ? 0 : h <= 0.5 ? c / u : c / (2 - u)), [Math.round(e) % 360, n, h, null == s ? 1 : s]
                );
            }),
            ...
            x(v, function (l, t) {
                var n = t.props,
                    ...
                    c = t.from;
                (m.fn[l] = function (t) {
                    if ((a && !this[s] && (this[s] = a(this._rgba)), t === h)) return this[s].slice();
                    var e,
                        i = u.type(t),
                    ...
                    x(n, function (s, a) {
                        m.fn[s] ||
                            (m.fn[s] = function (t) {
                                ...
                                return "undefined" === n
                                    ? r
                                    : ("function" === n && ((t = t.call(this, r)), (n = u.type(t))),
                                      null == t && a.empty ? this : ("string" === n && (e = d.exec(t)) && (t = r + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), (o[a.idx] = t), this[i](o)));
                            });
                    });
            }),
            (m.hook = function (t) {
                ...
                x(e, function (t, r) {
                    (u.cssHooks[r] = {
                        ...
                        (u.fx.step[r] = function (t) {
                            t.colorInit || ((t.start = m(t.elem, r)), (t.end = m(t.end)), (t.colorInit = !0)), u.cssHooks[r].set(t.elem, t.start.transition(t.end, t.pos));
                        });
                });
            }),
            ...
            (S = ["add", "remove", "toggle"]),
            (k = { border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1 }),
                            ...
                            return (
                                ...
                                (this.diff = (function (t, e) {
                                    var n,
                                        i,
                                        o = {};
                                    for (n in e) (i = e[n]), t[n] !== i && (k[n] || (!y.fx.step[n] && isNaN(parseFloat(i))) || (o[n] = i));
                                    return o;
                                })(this.start, this.end)),
                                this
                            );
            ...
            y.fn.extend({
                addClass:
                    ((T = y.fn.addClass),
                    function (t, e, n, i) {
                        return e ? y.effects.animateClass.call(this, { add: t }, e, n, i) : T.apply(this, arguments);
                    }),
                removeClass:
                    ((E = y.fn.removeClass),
                    function (t, e, n, i) {
                        return 1 < arguments.length ? y.effects.animateClass.call(this, { remove: t }, e, n, i) : E.apply(this, arguments);
                    }),
                toggleClass:
                    ((C = y.fn.toggleClass),
                    function (t, e, n, i, o) {
                        return "boolean" == typeof e || void 0 === e ? (n ? y.effects.animateClass.call(this, e ? { add: t } : { remove: t }, n, i, o) : C.apply(this, arguments)) : y.effects.animateClass.call(this, { toggle: t }, e, n, i);
                    }),
                switchClass: function (t, e, n, i, o) {
                    return y.effects.animateClass.call(this, { add: e, remove: t }, n, i, o);
                },
            }),
            y.extend(y.effects, {
                version: "1.11.4",
                save: function (t, e) {
                    for (var n = 0; n < e.length; n++) null !== e[n] && t.data(A + e[n], t[0].style[e[n]]);
                },
                restore: function (t, e) {
                    var n, i;
                    for (i = 0; i < e.length; i++) null !== e[i] && (void 0 === (n = t.data(A + e[i])) && (n = ""), t.css(e[i], n));
                },
                ...
                createWrapper: function (n) {
                    ...
                    var i = { width: n.outerWidth(!0), height: n.outerHeight(!0), float: n.css("float") },
                        t = y("<div></div>").addClass("ui-effects-wrapper").css({ fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0 }),
                    ...
                    return (
                        ...
                        "static" === n.css("position")
                            ...
                            : (y.extend(i, { position: n.css("position"), zIndex: n.css("z-index") }),
            ...
            y.fn.extend({
                effect: function () {
                    ...
                    function n(t) {
                        ...
                        (e.is(":hidden") ? "hide" === i : "show" === i) ? (e[i](), o()) : s.call(e[0], r, o);
                    }
                ...
                toggle:
                    ((D = y.fn.toggle),
                    function (t) {
                        if (q(t) || "boolean" == typeof t) return D.apply(this, arguments);
                        var e = R.apply(this, arguments);
    ...
    (function (t, e) {
        ...
        function a(t, e, n, i) {
            return Math.max(
                ...
                n["offset" + t],
                n["scroll" + t],
                m(10) ? parseInt(n["offset" + t]) + parseInt(i["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0
            );
        }
        function w(t) {
            var e = t.body,
        ...
        function S(t, e) {
            ...
            var h = E({ top: r.top - s.top - c, left: r.left - s.left - u, width: r.width, height: r.height });
            if (((h.marginTop = 0), (h.marginLeft = 0), !i && o)) {
                var f = parseFloat(l.marginTop),
                    p = parseFloat(l.marginLeft);
                (h.top -= c - f), (h.bottom -= c - f), (h.left -= u - p), (h.right -= u - p), (h.marginTop = f), (h.marginLeft = p);
            }
            return (
        ...
        function O(t, n, e) {
            return (
                (void 0 === e
                    ...
                    t.enabled && s(e) && ((n.offsets.popper = E(n.offsets.popper)), (n.offsets.reference = E(n.offsets.reference)), (n = e(n, t)));
                }),
                n
            );
        }
        ...
        function M(t, e, n, i) {
            ...
            return (
                (function t(e, n, i, o) {
                    ...
                    s.addEventListener(n, i, { passive: !0 }), r || t(d(s.parentNode), n, i, o), o.push(s);
        ...
        function W(n, i) {
            Object.keys(i).forEach(function (t) {
                var e = "";
                -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && q(i[t]) && (e = "px"), (n.style[t] = i[t] + e);
            });
        }
                ...
                modifiers: {
                        ...
                        fn: function (t, i) {
                            ...
                            var c = i.priority,
                                ...
                                h = {
                                    primary: function (t) {
                                        var e = u[t];
                                        return u[t] < l[t] && !i.escapeWithReference && (e = Math.max(u[t], l[t])), x({}, t, e);
                                    },
                                    secondary: function (t) {
                                        var e = "right" === t ? "left" : "top",
                                            n = u[e];
                                        return u[t] > l[t] && !i.escapeWithReference && (n = Math.min(u[e], l[t] - ("right" === t ? u.width : u.height))), x({}, e, n);
                                    },
                                };
                            return (
                    ...
                    arrow: {
                        ...
                        fn: function (t, e) {
                            ...
                            var o = t.placement.split("-")[0],
                                ...
                                p = l ? "bottom" : "right",
                                d = I(i)[c];
                            a[p] - d < s[h] && (t.offsets.popper[h] -= s[h] - (a[p] - d)), a[h] + d > s[p] && (t.offsets.popper[h] += a[h] + d - s[p]), (t.offsets.popper = E(t.offsets.popper));
                            var g = a[h] + a[c] / 2 - d / 2,
                                m = _(t.instance.popper),
                                v = parseFloat(m["margin" + u]),
                                b = parseFloat(m["border" + u + "Width"]),
                                y = g - t.offsets.popper[h] - v - b;
                            return (y = Math.max(Math.min(s[c] - d, y), 0)), (t.arrowElement = i), (t.offsets.arrow = (x((n = {}), h, Math.round(y)), x(n, f, ""), n)), t;
                        },
                        element: "[x-arrow]",
                    },
                    flip: {
                        ...
                        enabled: !0,
                        fn: function (g, m) {
                            if (L(g.instance.modifiers, "inner")) return g;
                            ...
                            return (
                                w.forEach(function (t, e) {
                                    ...
                                    (r || u || d) &&
                                        ...
                                        (g.placement = b + (_ ? "-" + _ : "")),
                                        (g.offsets.popper = C({}, g.offsets.popper, N(g.instance.popper, g.offsets.reference, g.placement))),
                    ...
                    inner: {
                        ...
                        fn: function (t) {
                            ...
                            return (o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0)), (t.placement = P(e)), (t.offsets.popper = E(o)), t;
                        },
                    },
                    hide: {
                        order: 800,
                    ...
                    computeStyle: {
                        ...
                        fn: function (t, e) {
                            ...
                            var s = void 0 !== r ? r : e.gpuAcceleration,
                                ...
                                u = (function (t, e) {
                                    ...
                                    var i = t.offsets,
                                        ...
                                        p = e ? s : n;
                                    return { left: f(l % 2 == 1 && c % 2 == 1 && !h && e ? o.left - 1 : o.left), top: p(o.top), bottom: p(o.bottom), right: f(o.right) };
                            ...
                            if (
                                ...
                                (c[p] = "translate3d(" + d + "px, " + g + "px, 0)"), (c[h] = 0), (c[f] = 0), (c.willChange = "transform");
                            else {
                                var m = "bottom" == h ? -1 : 1,
                                    v = "right" == f ? -1 : 1;
                                (c[h] = g * m), (c[f] = d * v), (c.willChange = h + ", " + f);
                            }
                    ...
                    applyStyle: {
                        ...
                        onLoad: function (t, e, n, i, o) {
                            ...
                            return e.setAttribute("x-placement", s), W(e, { position: n.positionFixed ? "fixed" : "absolute" }), n;
                        },
    ...
    (function (t, e) {
        ...
        (d = d && d.hasOwnProperty("default") ? d.default : d), (h = h && h.hasOwnProperty("default") ? h.default : h);
        var n = "transitionend";
        function o(t) {
            var e = this,
                n = !1;
                ...
                return (
                    ...
                    (t._getRootElement = function (t) {
                        var e = g.getSelectorFromElement(t),
                            n = !1;
                        return e && (n = document.querySelector(e)), n || (n = d(t).closest("." + p)[0]), n;
                    }),
                    (t._triggerCloseEvent = function (t) {
                        var e = d.Event(f.CLOSE);
                        return d(t).trigger(e), e;
                    }),
                    (t._removeElement = function (e) {
                        var n = this;
                        if ((d(e).removeClass(v), d(e).hasClass(m))) {
                    ...
                    (t._destroyElement = function (t) {
                        d(t).detach().trigger(f.CLOSED).remove();
                    }),
        ...
        d(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', b._handleDismiss(new b())),
            (d.fn[r] = b._jQueryInterface),
            (d.fn[r].Constructor = b),
            (d.fn[r].noConflict = function () {
                return (d.fn[r] = u), b._jQueryInterface;
            });
        var y = "button",
            _ = "bs.button",
            w = "." + _,
            ...
            P = '[data-toggle="buttons"] .btn',
            N = 'input:not([type="hidden"])',
            A = ".active",
            O = ".btn",
            L = { CLICK_DATA_API: "click" + w + x, FOCUS_BLUR_DATA_API: "focus" + w + x + " blur" + w + x, LOAD_DATA_API: "load" + w + x },
            j = (function () {
                function n(t) {
                    this._element = t;
                }
                ...
                return (
                    (t.toggle = function () {
                        ...
                        if (n) {
                            ...
                            if (i) {
                                ...
                                else "checkbox" === i.type ? "LABEL" === this._element.tagName && i.checked === this._element.classList.contains(E) && (t = !1) : (t = !1);
                                t && ((i.checked = !this._element.classList.contains(E)), d(i).trigger("change")), i.focus(), (e = !1);
                            }
                        }
                        this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(E)), t && d(this._element).toggleClass(E));
                    }),
                    (t.dispose = function () {
                    ...
                    (n._jQueryInterface = function (e) {
                        return this.each(function () {
                            var t = d(this).data(_);
                            t || ((t = new n(this)), d(this).data(_, t)), "toggle" === e && t[e]();
                        });
                    }),
                    s(n, null, [
                        {
        ...
        d(document)
            .on(L.CLICK_DATA_API, k, function (t) {
                var e = t.target;
                if ((d(e).hasClass(T) || (e = d(e).closest(O)[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))) t.preventDefault();
                else {
                    var n = e.querySelector(N);
                    if (n && (n.hasAttribute("disabled") || n.classList.contains("disabled"))) return void t.preventDefault();
                    j._jQueryInterface.call(d(e), "toggle");
                }
            })
            .on(L.FOCUS_BLUR_DATA_API, k, function (t) {
                var e = d(t.target).closest(O)[0];
                d(e).toggleClass(S, /^focus(in)?$/.test(t.type));
            }),
            d(window).on(L.LOAD_DATA_API, function () {
                ...
                for (var r = 0, s = (t = [].slice.call(document.querySelectorAll(I))).length; r < s; r++) {
                    var a = t[r];
                    "true" === a.getAttribute("aria-pressed") ? a.classList.add(E) : a.classList.remove(E);
                }
            }),
            (d.fn[y] = j._jQueryInterface),
            (d.fn[y].Constructor = j),
            (d.fn[y].noConflict = function () {
                return (d.fn[y] = C), j._jQueryInterface;
            });
        var H = "carousel",
            M = "bs.carousel",
            R = "." + M,
            ...
            ut = (function () {
                ...
                return (
                    ...
                    (t.dispose = function () {
                        d(this._element).off(R),
                            d.removeData(this._element, M),
                            (this._items = null),
                            (this._config = null),
                            (this._element = null),
                            (this._interval = null),
                    ...
                    (t._getConfig = function (t) {
                        return (t = l({}, W, {}, t)), g.typeCheckConfig(H, t, F), t;
                    }),
                    ...
                    (t._addEventListeners = function () {
                        ...
                        this._config.keyboard &&
                            d(this._element).on(V.KEYDOWN, function (t) {
                                return e._keydown(t);
                            }),
                    ...
                    (t._addTouchEventListeners = function () {
                        ...
                        if (this._touchSupported) {
                            var n = function (t) {
                                    e._pointerEvent && ct[t.originalEvent.pointerType.toUpperCase()] ? (e.touchStartX = t.originalEvent.clientX) : e._pointerEvent || (e.touchStartX = t.originalEvent.touches[0].clientX);
                                },
                                i = function (t) {
                                    e._pointerEvent && ct[t.originalEvent.pointerType.toUpperCase()] && (e.touchDeltaX = t.originalEvent.clientX - e.touchStartX),
                                        e._handleSwipe(),
                            ...
                            d(this._element.querySelectorAll(ot)).on(V.DRAG_START, function (t) {
                                return t.preventDefault();
                            }),
                                this._pointerEvent
                                    ? (d(this._element).on(V.POINTERDOWN, function (t) {
                                          return n(t);
                                      }),
                                      d(this._element).on(V.POINTERUP, function (t) {
                                          return i(t);
                                      }),
                                      this._element.classList.add(tt))
                                    : (d(this._element).on(V.TOUCHSTART, function (t) {
                                          return n(t);
                                      }),
                                      d(this._element).on(V.TOUCHMOVE, function (t) {
                                          return (function (t) {
                                              t.originalEvent.touches && 1 < t.originalEvent.touches.length ? (e.touchDeltaX = 0) : (e.touchDeltaX = t.originalEvent.touches[0].clientX - e.touchStartX);
                                          })(t);
                                      }),
                                      d(this._element).on(V.TOUCHEND, function (t) {
                                          return i(t);
                                      }));
                        }
                    }),
                    ...
                    (t._triggerSlideEvent = function (t, e) {
                        var n = this._getItemIndex(t),
                            ...
                            o = d.Event(V.SLIDE, { relatedTarget: t, direction: e, from: i, to: n });
                        return d(this._element).trigger(o), o;
                    }),
                    (t._setActiveIndicatorElement = function (t) {
                        if (this._indicatorsElement) {
                            var e = [].slice.call(this._indicatorsElement.querySelectorAll(et));
                            d(e).removeClass(X);
                    ...
                    (t._slide = function (t, e) {
                        var n,
                            ...
                            o,
                            r = this,
                            s = this._element.querySelector(nt),
                            a = this._getItemIndex(s),
                            l = e || (s && this._getItemByDirection(t, s)),
                            c = this._getItemIndex(l),
                            u = Boolean(this._interval);
                        if (((o = t === B ? ((n = G), (i = J), z) : ((n = $), (i = Z), Y)), l && d(l).hasClass(X))) this._isSliding = !1;
                        else if (!this._triggerSlideEvent(l, o).isDefaultPrevented() && s && l) {
                            (this._isSliding = !0), u && this.pause(), this._setActiveIndicatorElement(l);
                            var h = d.Event(V.SLID, { relatedTarget: l, direction: o, from: a, to: c });
                            if (d(this._element).hasClass(Q)) {
                                d(l).addClass(i), g.reflow(l), d(s).addClass(n), d(l).addClass(n);
                            ...
                            } else d(s).removeClass(X), d(l).addClass(X), (this._isSliding = !1), d(this._element).trigger(h);
                            u && this.cycle();
                        }
                    }),
                    (r._jQueryInterface = function (i) {
                        return this.each(function () {
                            ...
                            if ((t || ((t = new r(this, e)), d(this).data(M, t)), "number" == typeof i)) t.to(i);
                    ...
                    (r._dataApiClickHandler = function (t) {
                        ...
                        if (e) {
                            ...
                            if (n && d(n).hasClass(K)) {
                                ...
                                o && (i.interval = !1), r._jQueryInterface.call(d(n), i), o && d(n).data(M).to(o), t.preventDefault();
                            }
                        }
                    }),
                    s(r, null, [
        ...
        d(document).on(V.CLICK_DATA_API, at, ut._dataApiClickHandler),
            ...
            (d.fn[H] = ut._jQueryInterface),
            (d.fn[H].Constructor = ut),
            (d.fn[H].noConflict = function () {
                return (d.fn[H] = q), ut._jQueryInterface;
            });
        var ht = "collapse",
            ft = "bs.collapse",
            pt = "." + ft,
            ...
            St = (function () {
                ...
                return (
                    (t.toggle = function () {
                        d(this._element).hasClass(bt) ? this.hide() : this.show();
                    }),
                    (t.show = function () {
                        var t,
                            e,
                        ...
                        if (
                            ...
                            (this._parent &&
                                ...
                                (t = null),
                            !(t && (e = d(t).not(this._selector).data(ft)) && e._isTransitioning))
                        ) {
                            var i = d.Event(vt.SHOW);
                            if ((d(this._element).trigger(i), !i.isDefaultPrevented())) {
                                t && (a._jQueryInterface.call(d(t).not(this._selector), "hide"), e || d(t).data(ft, null));
                                var o = this._getDimension();
                                d(this._element).removeClass(yt).addClass(_t), (this._element.style[o] = 0), this._triggerArray.length && d(this._triggerArray).removeClass(wt).attr("aria-expanded", !0), this.setTransitioning(!0);
                                var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                                    s = g.getTransitionDurationFromElement(this._element);
                                d(this._element)
                                    .one(g.TRANSITION_END, function () {
                                        d(n._element).removeClass(_t).addClass(yt).addClass(bt), (n._element.style[o] = ""), n.setTransitioning(!1), d(n._element).trigger(vt.SHOWN);
                                    })
                    ...
                    (t.hide = function () {
                        var t = this;
                        if (!this._isTransitioning && d(this._element).hasClass(bt)) {
                            var e = d.Event(vt.HIDE);
                            if ((d(this._element).trigger(e), !e.isDefaultPrevented())) {
                                var n = this._getDimension();
                                (this._element.style[n] = this._element.getBoundingClientRect()[n] + "px"), g.reflow(this._element), d(this._element).addClass(_t).removeClass(yt).removeClass(bt);
                                var i = this._triggerArray.length;
                                if (0 < i)
                                    for (var o = 0; o < i; o++) {
                                        var r = this._triggerArray[o],
                                            s = g.getSelectorFromElement(r);
                                        if (null !== s) d([].slice.call(document.querySelectorAll(s))).hasClass(bt) || d(r).addClass(wt).attr("aria-expanded", !1);
                                    }
                                ...
                                d(this._element)
                                    .one(g.TRANSITION_END, function () {
                                        t.setTransitioning(!1), d(t._element).removeClass(_t).addClass(yt).trigger(vt.HIDDEN);
                                    })
                    ...
                    (t.dispose = function () {
                        d.removeData(this._element, ft), (this._config = null), (this._parent = null), (this._element = null), (this._triggerArray = null), (this._isTransitioning = null);
                    }),
                    (t._getConfig = function (t) {
                        return ((t = l({}, gt, {}, t)).toggle = Boolean(t.toggle)), g.typeCheckConfig(ht, t, mt), t;
                    }),
                    (t._getDimension = function () {
                        return d(this._element).hasClass(xt) ? xt : Ct;
                    }),
                    ...
                    (t._addAriaAndCollapsedClass = function (t, e) {
                        var n = d(t).hasClass(bt);
                        e.length && d(e).toggleClass(wt, !n).attr("aria-expanded", n);
                    }),
        ...
        d(document).on(vt.CLICK_DATA_API, Tt, function (t) {
            ...
            (d.fn[ht] = St._jQueryInterface),
            (d.fn[ht].Constructor = St),
            (d.fn[ht].noConflict = function () {
                return (d.fn[ht] = dt), St._jQueryInterface;
            });
        var kt = "dropdown",
            Dt = "bs.dropdown",
            It = "." + Dt,
            ...
            Ot = { HIDE: "hide" + It, HIDDEN: "hidden" + It, SHOW: "show" + It, SHOWN: "shown" + It, CLICK: "click" + It, CLICK_DATA_API: "click" + It + Pt, KEYDOWN_DATA_API: "keydown" + It + Pt, KEYUP_DATA_API: "keyup" + It + Pt },
            Lt = "disabled",
            jt = "show",
            Ht = "dropup",
            Mt = "dropright",
            ...
            te = (function () {
                ...
                return (
                    (t.toggle = function () {
                        if (!this._element.disabled && !d(this._element).hasClass(Lt)) {
                            var t = d(this._menu).hasClass(jt);
                            c._clearMenus(), t || this.show(!0);
                        }
                    }),
                    (t.show = function (t) {
                        if ((void 0 === t && (t = !1), !(this._element.disabled || d(this._element).hasClass(Lt) || d(this._menu).hasClass(jt)))) {
                            ...
                            if ((d(i).trigger(n), !n.isDefaultPrevented())) {
                                if (!this._inNavbar && t) {
                                    ...
                                    "parent" === this._config.reference ? (o = i) : g.isElement(this._config.reference) && ((o = this._config.reference), void 0 !== this._config.reference.jquery && (o = this._config.reference[0])),
                                        "scrollParent" !== this._config.boundary && d(i).addClass(Wt),
                                        (this._popper = new h(o, this._menu, this._getPopperConfig()));
                                }
                                "ontouchstart" in document.documentElement && 0 === d(i).closest(zt).length && d(document.body).children().on("mouseover", null, d.noop),
                                    this._element.focus(),
                                    this._element.setAttribute("aria-expanded", !0),
                                    d(this._menu).toggleClass(jt),
                                    d(i).toggleClass(jt).trigger(d.Event(Ot.SHOWN, e));
                            }
                        }
                    }),
                    (t.hide = function () {
                        if (!this._element.disabled && !d(this._element).hasClass(Lt) && d(this._menu).hasClass(jt)) {
                            var t = { relatedTarget: this._element },
                                e = d.Event(Ot.HIDE, t),
                                n = c._getParentFromElement(this._element);
                            d(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), d(this._menu).toggleClass(jt), d(n).toggleClass(jt).trigger(d.Event(Ot.HIDDEN, t)));
                        }
                    }),
                    (t.dispose = function () {
                        d.removeData(this._element, Dt), d(this._element).off(It), (this._element = null), (this._menu = null) !== this._popper && (this._popper.destroy(), (this._popper = null));
                    }),
                    (t.update = function () {
                    ...
                    (t._addEventListeners = function () {
                        var e = this;
                        d(this._element).on(Ot.CLICK, function (t) {
                            t.preventDefault(), t.stopPropagation(), e.toggle();
                        });
                    }),
                    (t._getConfig = function (t) {
                        return (t = l({}, this.constructor.Default, {}, d(this._element).data(), {}, t)), g.typeCheckConfig(kt, t, this.constructor.DefaultType), t;
                    }),
                    ...
                    (t._getPlacement = function () {
                        var t = d(this._element.parentNode),
                            e = Xt;
                        return t.hasClass(Ht) ? ((e = Vt), d(this._menu).hasClass(qt) && (e = Kt)) : t.hasClass(Mt) ? (e = $t) : t.hasClass(Rt) ? (e = Gt) : d(this._menu).hasClass(qt) && (e = Qt), e;
                    }),
                    ...
                    (c._jQueryInterface = function (e) {
                        return this.each(function () {
                            var t = d(this).data(Dt);
                            if ((t || ((t = new c(this, "object" == typeof e ? e : null)), d(this).data(Dt, t)), "string" == typeof e)) {
                    ...
                    (c._clearMenus = function (t) {
                        if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
                            for (var e = [].slice.call(document.querySelectorAll(Ft)), n = 0, i = e.length; n < i; n++) {
                                var o = c._getParentFromElement(e[n]),
                                    r = d(e[n]).data(Dt),
                                    s = { relatedTarget: e[n] };
                                if ((t && "click" === t.type && (s.clickEvent = t), r)) {
                                    var a = r._menu;
                                    if (d(o).hasClass(jt) && !(t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && 9 === t.which)) && d.contains(o, t.target))) {
                                        var l = d.Event(Ot.HIDE, s);
                                        d(o).trigger(l),
                                            l.isDefaultPrevented() ||
                                                ...
                                                d(a).removeClass(jt),
                                                d(o).removeClass(jt).trigger(d.Event(Ot.HIDDEN, s)));
                                    }
                                }
                            }
                    }),
                    ...
                    (c._dataApiKeydownHandler = function (t) {
                        if (
                            (/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || d(t.target).closest(Ut).length))) : At.test(t.which)) &&
                            (t.preventDefault(), t.stopPropagation(), !this.disabled && !d(this).hasClass(Lt))
                        ) {
                            var e = c._getParentFromElement(this),
                                n = d(e).hasClass(jt);
                            if (n || 27 !== t.which)
                                if (n && (!n || (27 !== t.which && 32 !== t.which))) {
                                    var i = [].slice.call(e.querySelectorAll(Yt)).filter(function (t) {
        ...
        d(document)
            .on(Ot.KEYDOWN_DATA_API, Ft, te._dataApiKeydownHandler)
            .on(Ot.KEYDOWN_DATA_API, Ut, te._dataApiKeydownHandler)
            .on(Ot.CLICK_DATA_API + " " + Ot.KEYUP_DATA_API, te._clearMenus)
            .on(Ot.CLICK_DATA_API, Ft, function (t) {
                t.preventDefault(), t.stopPropagation(), te._jQueryInterface.call(d(this), "toggle");
            })
            .on(Ot.CLICK_DATA_API, Bt, function (t) {
                t.stopPropagation();
            }),
            (d.fn[kt] = te._jQueryInterface),
            (d.fn[kt].Constructor = te),
            (d.fn[kt].noConflict = function () {
                return (d.fn[kt] = Nt), te._jQueryInterface;
            });
        var ee = "modal",
            ne = "bs.modal",
            ie = "." + ne,
            ...
            le = "modal-dialog-scrollable",
            ce = "modal-scrollbar-measure",
            ue = "modal-backdrop",
            he = "modal-open",
            fe = "fade",
            pe = "show",
                ...
                return (
                    ...
                    (t.show = function (t) {
                        ...
                        if (!this._isShown && !this._isTransitioning) {
                            d(this._element).hasClass(fe) && (this._isTransitioning = !0);
                            var n = d.Event(ae.SHOW, { relatedTarget: t });
                            d(this._element).trigger(n),
                                this._isShown ||
                                    ...
                                    d(this._element).on(ae.CLICK_DISMISS, be, function (t) {
                                        return e.hide(t);
                                    }),
                                    d(this._dialog).on(ae.MOUSEDOWN_DISMISS, function () {
                                        d(e._element).one(ae.MOUSEUP_DISMISS, function (t) {
                    ...
                    (t.hide = function (t) {
                        ...
                        if ((t && t.preventDefault(), this._isShown && !this._isTransitioning)) {
                            var n = d.Event(ae.HIDE);
                            if ((d(this._element).trigger(n), this._isShown && !n.isDefaultPrevented())) {
                                this._isShown = !1;
                                var i = d(this._element).hasClass(fe);
                                if (
                                    (i && (this._isTransitioning = !0),
                                    this._setEscapeEvent(),
                                    this._setResizeEvent(),
                                    d(document).off(ae.FOCUSIN),
                                    d(this._element).removeClass(pe),
                                    d(this._element).off(ae.CLICK_DISMISS),
                                    d(this._dialog).off(ae.MOUSEDOWN_DISMISS),
                                    i)
                                ) {
                    ...
                    (t._getConfig = function (t) {
                        return (t = l({}, re, {}, t)), g.typeCheckConfig(ee, t, se), t;
                    }),
                    (t._triggerBackdropTransition = function () {
                        var t = this;
                        if ("static" === this._config.backdrop) {
                            var e = d.Event(ae.HIDE_PREVENTED);
                            if ((d(this._element).trigger(e), e.defaultPrevented)) return;
                    ...
                    (t._showElement = function (t) {
                        var e = this,
                            n = d(this._element).hasClass(fe),
                            i = this._dialog ? this._dialog.querySelector(me) : null;
                        (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                            (this._element.style.display = "block"),
                            this._element.removeAttribute("aria-hidden"),
                            this._element.setAttribute("aria-modal", !0),
                            d(this._dialog).hasClass(le) && i ? (i.scrollTop = 0) : (this._element.scrollTop = 0),
                            n && g.reflow(this._element),
                            d(this._element).addClass(pe),
                            this._config.focus && this._enforceFocus();
                        function o() {
                            e._config.focus && e._element.focus(), (e._isTransitioning = !1), d(e._element).trigger(r);
                        }
                        var r = d.Event(ae.SHOWN, { relatedTarget: t });
                        if (n) {
                    ...
                    (t._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ? d(this._element).on(ae.KEYDOWN_DISMISS, function (t) {
                                  27 === t.which && e._triggerBackdropTransition();
                              })
                            : this._isShown || d(this._element).off(ae.KEYDOWN_DISMISS);
                    }),
                    (t._setResizeEvent = function () {
                        var e = this;
                        this._isShown
                            ? d(window).on(ae.RESIZE, function (t) {
                                  return e.handleUpdate(t);
                              })
                            : d(window).off(ae.RESIZE);
                    }),
                    (t._hideModal = function () {
                        ...
                        (this._element.style.display = "none"),
                            ...
                            (this._isTransitioning = !1),
                            this._showBackdrop(function () {
                                d(document.body).removeClass(he), t._resetAdjustments(), t._resetScrollbar(), d(t._element).trigger(ae.HIDDEN);
                            });
                    }),
                    ...
                    (t._showBackdrop = function (t) {
                        var e = this,
                            n = d(this._element).hasClass(fe) ? fe : "";
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                d(this._element).on(ae.CLICK_DISMISS, function (t) {
                                    e._ignoreBackdropClick ? (e._ignoreBackdropClick = !1) : t.target === t.currentTarget && e._triggerBackdropTransition();
                                }),
                                n && g.reflow(this._backdrop),
                                d(this._backdrop).addClass(pe),
                                !t)
                            )
                                return;
                            if (!n) return void t();
                            ...
                            d(this._backdrop).removeClass(pe);
                            var o = function () {
                                e._removeBackdrop(), t && t();
                            };
                            if (d(this._element).hasClass(fe)) {
                    ...
                    (t._setScrollbar = function () {
                        ...
                        d(document.body).addClass(he);
                    }),
                    (t._resetScrollbar = function () {
                        var t = [].slice.call(document.querySelectorAll(ye));
                        d(t).each(function (t, e) {
                            var n = d(e).data("padding-right");
                            d(e).removeData("padding-right"), (e.style.paddingRight = n || "");
                        });
                    ...
                    (t._getScrollbarWidth = function () {
                        ...
                        (t.className = ce), document.body.appendChild(t);
                        var e = t.getBoundingClientRect().width - t.clientWidth;
                        return document.body.removeChild(t), e;
                    }),
                    (o._jQueryInterface = function (n, i) {
                        return this.each(function () {
                            var t = d(this).data(ne),
                                e = l({}, re, {}, d(this).data(), {}, "object" == typeof n && n ? n : {});
                            if ((t || ((t = new o(this, e)), d(this).data(ne, t)), "string" == typeof n)) {
                                if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                                t[n](i);
        ...
        d(document).on(ae.CLICK_DATA_API, ve, function (t) {
            var e,
                n = this,
                i = g.getSelectorFromElement(this);
            i && (e = document.querySelector(i));
            var o = d(e).data(ne) ? "toggle" : l({}, d(e).data(), {}, d(this).data());
            ("A" !== this.tagName && "AREA" !== this.tagName) || t.preventDefault();
            var r = d(e).one(ae.SHOW, function (t) {
                t.isDefaultPrevented() ||
                    r.one(ae.HIDDEN, function () {
                        d(n).is(":visible") && n.focus();
                    });
            });
            we._jQueryInterface.call(d(e), o, this);
        }),
            (d.fn[ee] = we._jQueryInterface),
            (d.fn[ee].Constructor = we),
            (d.fn[ee].noConflict = function () {
                return (d.fn[ee] = oe), we._jQueryInterface;
            });
                    ...
                    i = function (t, e) {
                        ...
                        o.forEach(function (t) {
                            !(function (t, e) {
                                ...
                                if (-1 !== e.indexOf(n)) return -1 === xe.indexOf(n) || Boolean(t.nodeValue.match(Ee) || t.nodeValue.match(Te));
                                for (
                ...
                return (
                    ...
                    (t.toggle = function (t) {
                        if (this._isEnabled)
                            if (t) {
                                ...
                                n || ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())), d(t.currentTarget).data(e, n)),
                                    (n._activeTrigger.click = !n._activeTrigger.click),
                                    n._isWithActiveTrigger() ? n._enter(null, n) : n._leave(null, n);
                            } else {
                                if (d(this.getTipElement()).hasClass(Fe)) return void this._leave(null, this);
                    ...
                    (t.show = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && d(o).addClass(We);
                            ...
                            var c = function () {
                                ...
                                var t = e._hoverState;
                                (e._hoverState = null), d(e.element).trigger(e.constructor.Event.SHOWN), t === Re && e._leave(null, e);
                            };
                            if (d(this.tip).hasClass(We)) {
                    ...
                    (t.addAttachmentClass = function (t) {
                        d(this.getTipElement()).addClass(Ne + "-" + t);
                    }),
                    ...
                    (t.setContent = function () {
                        ...
                        this.setElementContent(d(t.querySelectorAll(Be)), this.getTitle()), d(t).removeClass(We + " " + Fe);
                    }),
                    (t.setElementContent = function (t, e) {
                        "object" != typeof e || (!e.nodeType && !e.jquery)
                            ? this.config.html
                                ...
                                : t.text(e)
                            : this.config.html
                            ? d(e).parent().is(t) || t.empty().append(e)
                            : t.text(d(e).text());
                    }),
                    (t.getTitle = function () {
                    ...
                    (t._setListeners = function () {
                        ...
                        this.config.trigger.split(" ").forEach(function (t) {
                            if ("click" === t)
                                ...
                                var e = t === ze ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                                    n = t === ze ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                                d(i.element)
                    ...
                    (t._enter = function (t, e) {
                        ...
                        (e = e || d(t.currentTarget).data(n)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), d(t.currentTarget).data(n, e)),
                            t && (e._activeTrigger["focusin" === t.type ? Ye : ze] = !0),
                            d(e.getTipElement()).hasClass(Fe) || e._hoverState === Me
                                ? (e._hoverState = Me)
                    ...
                    (t._leave = function (t, e) {
                        var n = this.constructor.DATA_KEY;
                        (e = e || d(t.currentTarget).data(n)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), d(t.currentTarget).data(n, e)),
                            t && (e._activeTrigger["focusout" === t.type ? Ye : ze] = !1),
                    ...
                    (t._fixTransition = function () {
                        ...
                        null === t.getAttribute("x-placement") && (d(t).removeClass(We), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
                    }),
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            var t = d(this).data(De),
                                e = "object" == typeof n && n;
                            if ((t || !/dispose|hide/.test(n)) && (t || ((t = new i(this, e)), d(this).data(De, t)), "string" == typeof n)) {
                                if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                                t[n]();
                            }
                        });
        ...
        (d.fn[ke] = Xe._jQueryInterface),
            (d.fn[ke].Constructor = Xe),
            (d.fn[ke].noConflict = function () {
                return (d.fn[ke] = Pe), Xe._jQueryInterface;
            });
        var Qe = "popover",
            $e = "bs.popover",
            Ge = "." + $e,
            Je = d.fn[Qe],
            Ze = "bs-popover",
            tn = new RegExp("(^|\\s)" + Ze + "\\S+", "g"),
            en = l({}, Xe.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
            nn = l({}, Xe.DefaultType, { content: "(string|element|function)" }),
            on = "fade",
            rn = "show",
            sn = ".popover-header",
            an = ".popover-body",
            ...
            cn = (function (t) {
                ...
                return (
                    ...
                    (e.addAttachmentClass = function (t) {
                        d(this.getTipElement()).addClass(Ze + "-" + t);
                    }),
                    ...
                    (e.setContent = function () {
                        ...
                        "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(an), e), t.removeClass(on + " " + rn);
                    }),
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if ((t || !/dispose|hide/.test(n)) && (t || ((t = new i(this, e)), d(this).data($e, t)), "string" == typeof n)) {
                                if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                                t[n]();
                            }
                        });
        ...
        (d.fn[Qe] = cn._jQueryInterface),
            (d.fn[Qe].Constructor = cn),
            (d.fn[Qe].noConflict = function () {
                return (d.fn[Qe] = Je), cn._jQueryInterface;
            });
        var un = "scrollspy",
            hn = "bs.scrollspy",
            fn = "." + hn,
            ...
            mn = { ACTIVATE: "activate" + fn, SCROLL: "scroll" + fn, LOAD_DATA_API: "load" + fn + ".data-api" },
            vn = "dropdown-item",
            bn = "active",
            yn = '[data-spy="scroll"]',
            _n = ".nav, .list-group",
            ...
            In = (function () {
                function n(t, e) {
                    ...
                    (this._element = t),
                        ...
                        (this._config = this._getConfig(e)),
                        (this._selector = this._config.target + " " + wn + "," + this._config.target + " " + Cn + "," + this._config.target + " " + Tn),
                        (this._offsets = []),
                        (this._targets = []),
                        (this._activeTarget = null),
                        (this._scrollHeight = 0),
                        d(this._scrollElement).on(mn.SCROLL, function (t) {
                            return n._process(t);
                        }),
                        this.refresh(),
                        this._process();
                ...
                return (
                    (t.refresh = function () {
                        var e = this,
                            t = this._scrollElement === this._scrollElement.window ? kn : Dn,
                    ...
                    (t.dispose = function () {
                        d.removeData(this._element, hn),
                            d(this._scrollElement).off(fn),
                            (this._element = null),
                    ...
                    (t._getConfig = function (t) {
                        if ("string" != typeof (t = l({}, dn, {}, "object" == typeof t && t ? t : {})).target) {
                            ...
                            e || ((e = g.getUID(un)), d(t.target).attr("id", e)), (t.target = "#" + e);
                        }
                        return g.typeCheckConfig(un, t, gn), t;
                    }),
                    ...
                    (t._activate = function (e) {
                        ...
                        n.hasClass(vn)
                            ? (n.closest(En).find(Sn).addClass(bn), n.addClass(bn))
                            : (n.addClass(bn),
                              n
                                  .parents(_n)
                                  .prev(wn + ", " + Cn)
                                  .addClass(bn),
                              n.parents(_n).prev(xn).children(wn).addClass(bn)),
                            d(this._scrollElement).trigger(mn.ACTIVATE, { relatedTarget: e });
                    }),
                    (t._clear = function () {
                        [].slice
                            .call(document.querySelectorAll(this._selector))
                    ...
                    (n._jQueryInterface = function (e) {
                        return this.each(function () {
                            var t = d(this).data(hn);
                            if ((t || ((t = new n(this, "object" == typeof e && e)), d(this).data(hn, t)), "string" == typeof e)) {
                                if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                                t[e]();
                            }
                        });
        ...
        d(window).on(mn.LOAD_DATA_API, function () {
            for (var t = [].slice.call(document.querySelectorAll(yn)), e = t.length; e--; ) {
                var n = d(t[e]);
                In._jQueryInterface.call(n, n.data());
            }
        }),
            (d.fn[un] = In._jQueryInterface),
            (d.fn[un].Constructor = In),
            (d.fn[un].noConflict = function () {
                return (d.fn[un] = pn), In._jQueryInterface;
            });
        var Pn = "bs.tab",
            Nn = "." + Pn,
            An = d.fn.tab,
            On = { HIDE: "hide" + Nn, HIDDEN: "hidden" + Nn, SHOW: "show" + Nn, SHOWN: "shown" + Nn, CLICK_DATA_API: "click.bs.tab.data-api" },
            Ln = "dropdown-menu",
            jn = "active",
            Hn = "disabled",
            Mn = "fade",
            ...
            Fn = ".active",
            Bn = "> li > .active",
            Un = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',
            zn = ".dropdown-toggle",
            ...
            Vn = (function () {
                ...
                return (
                    (t.show = function () {
                        var n = this;
                        if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && d(this._element).hasClass(jn)) || d(this._element).hasClass(Hn))) {
                            var t,
                                i,
                                e = d(this._element).closest(Wn)[0],
                                o = g.getSelectorFromElement(this._element);
                            if (e) {
                                var r = "UL" === e.nodeName || "OL" === e.nodeName ? Bn : Fn;
                                i = (i = d.makeArray(d(e).find(r)))[i.length - 1];
                            }
                            var s = d.Event(On.HIDE, { relatedTarget: this._element }),
                                a = d.Event(On.SHOW, { relatedTarget: i });
                            if ((i && d(i).trigger(s), d(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented())) {
                                o && (t = document.querySelector(o)), this._activate(this._element, e);
                                var l = function () {
                                    var t = d.Event(On.HIDDEN, { relatedTarget: n._element }),
                                        e = d.Event(On.SHOWN, { relatedTarget: i });
                    ...
                    (t.dispose = function () {
                        d.removeData(this._element, Pn), (this._element = null);
                    }),
                    (t._activate = function (t, e, n) {
                        ...
                        var o = this,
                            r = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? d(e).children(Fn) : d(e).find(Bn))[0],
                            s = n && r && d(r).hasClass(Mn);
                        if (r && s) {
                            var a = g.getTransitionDurationFromElement(r);
                            d(r).removeClass(Rn).one(g.TRANSITION_END, i).emulateTransitionEnd(a);
                        } else i();
                    }),
                    (t._transitionComplete = function (t, e, n) {
                        if (e) {
                            d(e).removeClass(jn);
                            var i = d(e.parentNode).find(Yn)[0];
                            i && d(i).removeClass(jn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1);
                        }
                        if ((d(t).addClass(jn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains(Mn) && t.classList.add(Rn), t.parentNode && d(t.parentNode).hasClass(Ln))) {
                            var o = d(t).closest(qn)[0];
                            if (o) {
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            var t = d(this),
                                e = t.data(Pn);
                            if ((e || ((e = new i(this)), t.data(Pn, e)), "string" == typeof n)) {
        ...
        d(document).on(On.CLICK_DATA_API, Un, function (t) {
            t.preventDefault(), Vn._jQueryInterface.call(d(this), "show");
        }),
            (d.fn.tab = Vn._jQueryInterface),
            (d.fn.tab.Constructor = Vn),
            (d.fn.tab.noConflict = function () {
                return (d.fn.tab = An), Vn._jQueryInterface;
            });
        var Kn = "toast",
            Xn = "bs.toast",
            Qn = "." + Xn,
            $n = d.fn[Kn],
            Gn = { CLICK_DISMISS: "click.dismiss" + Qn, HIDE: "hide" + Qn, HIDDEN: "hidden" + Qn, SHOW: "show" + Qn, SHOWN: "shown" + Qn },
            Jn = "fade",
            Zn = "hide",
            ti = "show",
            ei = "showing",
            ni = { animation: "boolean", autohide: "boolean", delay: "number" },
            ii = { animation: !0, autohide: !0, delay: 500 },
                ...
                return (
                        ...
                        if ((d(this._element).trigger(e), !e.isDefaultPrevented())) {
                            ...
                            var n = function () {
                                t._element.classList.remove(ei),
                                    ...
                                    d(t._element).trigger(Gn.SHOWN),
                                    t._config.autohide &&
                                        (t._timeout = setTimeout(function () {
                                            t.hide();
                                        }, t._config.delay));
                            };
                            if ((this._element.classList.remove(Zn), g.reflow(this._element), this._element.classList.add(ei), this._config.animation)) {
                    ...
                    (t.hide = function () {
                        if (this._element.classList.contains(ti)) {
                            var t = d.Event(Gn.HIDE);
                            d(this._element).trigger(t), t.isDefaultPrevented() || this._close();
                        }
                    }),
                    (t.dispose = function () {
                        clearTimeout(this._timeout),
                            ...
                            d(this._element).off(Gn.CLICK_DISMISS),
                            d.removeData(this._element, Xn),
                            (this._element = null),
                            (this._config = null);
                    }),
                    (t._getConfig = function (t) {
                        return (t = l({}, ii, {}, d(this._element).data(), {}, "object" == typeof t && t ? t : {})), g.typeCheckConfig(Kn, t, this.constructor.DefaultType), t;
                    }),
                    (t._setListeners = function () {
                        var t = this;
                        d(this._element).on(Gn.CLICK_DISMISS, oi, function () {
                            return t.hide();
                        });
                    }),
                    (t._close = function () {
                        function t() {
                            e._element.classList.add(Zn), d(e._element).trigger(Gn.HIDDEN);
                        }
                        var e = this;
        ...
        (d.fn[Kn] = ri._jQueryInterface),
            (d.fn[Kn].Constructor = ri),
            (d.fn[Kn].noConflict = function () {
                return (d.fn[Kn] = $n), ri._jQueryInterface;
            }),
            (t.Alert = b),
            (t.Button = j),
            (t.Carousel = ut),
    ...
    (function (t, e) {
        ...
        var p = {},
            ...
            g = { locale: "en", backdrop: "static", animate: !0, className: null, closeButton: !0, show: !0, container: "body", value: "", inputType: "text", swapButtonOrder: !1, centerVertical: !1, multiple: !1, scrollable: !1 };
        function l(t, e, n) {
            return u.extend(
                !0,
                {},
        ...
        function m(t, e, n, i) {
            var o;
            i && i[0] && ((o = i[0].locale || g.locale), (i[0].swapButtonOrder || g.swapButtonOrder) && (e = e.reverse()));
            return (function (t, e) {
                var n = {};
                return (
                    b(e, function (t, e) {
                    ...
                    b(t.buttons, function (t) {
                        if (n[t] === h) throw new Error('button key "' + t + '" is not allowed (options are ' + e.join(" ") + ")");
                    }),
                    t
                );
            })(
                        ...
                        buttons: (function (t, e) {
                            for (var n = {}, i = 0, o = t.length; i < o; i++) {
                                var r = t[i],
                                    s = r.toLowerCase(),
                                    a = r.toUpperCase();
                                n[s] = { label: ((l = a), (c = e), void 0, (u = p[c]), u ? u[l] : p.en[l]) };
                            }
                            var l, c, u;
                            return n;
                        })(e, o),
        ...
        function y(t, e, n) {
            t.stopPropagation(), t.preventDefault(), (u.isFunction(n) && !1 === n.call(e, t)) || e.modal("hide");
        }
        function _(t) {
        ...
        return (
            ...
            (f.addLocale = function (t, n) {
                return (
                    ...
                    (p[t] = { OK: n.OK, CANCEL: n.CANCEL, CONFIRM: n.CONFIRM }),
                    f
                );
            }),
            ...
            (f.setDefaults = function () {
                var t = {};
                return 2 === arguments.length ? (t[arguments[0]] = arguments[1]) : (t = arguments[0]), u.extend(g, t), f;
            }),
            (f.setTemplates = function () {
                var t = {};
                3 === arguments.length ? ((t[arguments[0]] = {}), (t[arguments[0]][arguments[1]] = arguments[2])) : 2 === arguments.length ? (t[arguments[0]] = arguments[1]) : (t = arguments[0]), u.extend(d, t);
            }),
            (f.hideAll = function () {
            ...
            (f.dialog = function (t) {
                if (u.fn.modal === h) throw new Error('"$.fn.modal" is not defined; please double check you have included the Bootstrap JavaScript library. See http://getbootstrap.com/javascript/ for more details.');
                if (
                    ((t = (function (o) {
                        var r, s;
                        if ("object" != typeof o) throw new Error("Please supply an object of options");
                        if (!o.message) throw new Error('"message" option must not be null or an empty string.');
                        (o = u.extend({}, g, o)).buttons || (o.buttons = {});
                        return (
                            (r = o.buttons),
                            (s = v(r)),
                            b(r, function (t, e, n) {
                                if ((u.isFunction(e) && (e = r[t] = { callback: e }), "object" !== u.type(e))) throw new Error('button with key "' + t + '" must be an object');
                                if ((e.label || (e.label = t), !e.className)) {
                                    var i = !1;
                                    (i = o.swapButtonOrder ? 0 === n : n === s - 1), (e.className = s <= 2 && i ? "btn-primary" : "btn-secondary btn-default");
                                }
                            }),
                            o
                        );
                ...
                if (
                    ...
                    0 < v(t.buttons) &&
                        (b(a, function (t, e) {
                            var n = u(d.button);
                            switch ((n.data("bb-handler", t), n.addClass(e.className), t)) {
                                case "ok":
                                case "confirm":
                    ...
                    switch ((t.fullBootstrapVersion.substring(0, 3) < "3.1" && console.warn('"size" requires Bootstrap 3.1.0 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option."), t.size)) {
                        ...
                        case "extra-large":
                            t.fullBootstrapVersion.substring(0, 3) < "4.2" &&
                                console.warn('Using size "xl"/"extra-large" requires Bootstrap 4.2.0 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option."),
                                i.addClass("modal-xl");
                    }
                if (
                    (t.scrollable &&
                        (t.fullBootstrapVersion.substring(0, 3) < "4.3" && console.warn('Using "scrollable" requires Bootstrap 4.3.0 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option."),
                ...
                return (
                    t.centerVertical &&
                        (t.fullBootstrapVersion < "4.0.0" && console.warn('"centerVertical" requires Bootstrap 4.0.0-beta.3 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option."),
                    ...
                    n.modal({ backdrop: !!t.backdrop && "static", keyboard: !1, show: !1 }),
                    t.show && n.modal("show"),
                    n
                );
            }),
            (f.alert = function () {
                var t;
                if ((t = m("alert", ["ok"], ["message", "callback"], arguments)).callback && !u.isFunction(t.callback)) throw new Error('alert requires the "callback" property to be a function when provided');
                return (
            ...
            (f.confirm = function () {
                var t;
                if (((t = m("confirm", ["cancel", "confirm"], ["message", "callback"], arguments)), !u.isFunction(t.callback))) throw new Error("confirm requires a callback");
                return (
            ...
            (f.prompt = function () {
                    ...
                    (o.buttons.confirm.callback = function () {
                        ...
                        if ("checkbox" === o.inputType)
                            t = r
                                ...
                                .get();
                        else if ("radio" === o.inputType) t = r.find("input:checked").val();
                        else {
                ...
                if (!u.isFunction(o.callback)) throw new Error("prompt requires a callback");
                ...
                switch (((r = u(d.inputs[o.inputType])), o.inputType)) {
                    ...
                    case "password":
                        r.val(o.value),
                            ...
                            o.required && r.prop({ required: !0 }),
                            o.rows && !isNaN(parseInt(o.rows)) && "textarea" === o.inputType && r.attr({ rows: o.rows });
                        break;
                    case "date":
                    case "time":
                    case "number":
                    case "range":
                        if ((r.val(o.value), o.placeholder && r.attr("placeholder", o.placeholder), o.pattern && r.attr("pattern", o.pattern), o.required && r.prop({ required: !0 }), "date" !== o.inputType && o.step)) {
                        ...
                        !(function (t, e, n) {
                            ...
                            if ("date" === t)
                                ...
                                if (e !== h && !(o = _(e))) throw new Error('"min" is not a valid time. See https://www.w3.org/TR/2012/WD-html-markup-20120315/datatypes.html#form.data.time for more information.');
                                if (n !== h && !(r = _(n))) throw new Error('"max" is not a valid time. See https://www.w3.org/TR/2012/WD-html-markup-20120315/datatypes.html#form.data.time for more information.');
                            } else {
                                if (e !== h && isNaN(e)) throw new Error('"min" must be a valid number. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-min for more information.');
                                if (n !== h && isNaN(n)) throw new Error('"max" must be a valid number. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-max for more information.');
                            }
                            if (o && r) {
                                if (n <= e) throw new Error('"max" must be greater than "min". See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-max for more information.');
                                i = !0;
                            }
                            return i;
                        })(o.inputType, o.min, o.max) || (o.min !== h && r.attr("min", o.min), o.max !== h && r.attr("max", o.max));
                        break;
                    case "select":
                        var s = {};
                        if (((i = o.inputOptions || []), !u.isArray(i))) throw new Error("Please pass an array of input options");
                        if (!i.length) throw new Error('prompt with "inputType" set to "select" requires at least one option');
                        o.placeholder && r.attr("placeholder", o.placeholder),
                            o.required && r.prop({ required: !0 }),
                            o.multiple && r.prop({ multiple: !0 }),
                            b(i, function (t, e) {
                                var n = r;
                                if (e.value === h || e.text === h) throw new Error('each option needs a "value" property and a "text" property');
                                e.group && (s[e.group] || (s[e.group] = u("<optgroup />").attr("label", e.group)), (n = s[e.group]));
                                var i = u(d.option);
                    ...
                    case "checkbox":
                        ...
                        if (!(i = o.inputOptions || []).length) throw new Error('prompt with "inputType" set to "checkbox" requires at least one option');
                        (r = u('<div class="bootbox-checkbox-list"></div>')),
                            b(i, function (t, n) {
                                if (n.value === h || n.text === h) throw new Error('each option needs a "value" property and a "text" property');
                        ...
                        break;
                    case "radio":
                        if (o.value !== h && u.isArray(o.value)) throw new Error('prompt with "inputType" set to "radio" requires a single, non-array value for "value"');
                        if (!(i = o.inputOptions || []).length) throw new Error('prompt with "inputType" set to "radio" requires at least one option');
                        r = u('<div class="bootbox-radiobutton-list"></div>');
                        var l = !0;
                        b(i, function (t, e) {
                            if (e.value === h || e.text === h) throw new Error('each option needs a "value" property and a "text" property');
                            var n = u(d.inputs[o.inputType]);
                            n.find("input").attr("value", e.value), n.find("label").append("\n" + e.text), o.value !== h && e.value === o.value && (n.find("input").prop("checked", !0), (l = !1)), r.append(n);
                        }),
            ...
            f.addLocale("en", { OK: "OK", CANCEL: "Cancel", CONFIRM: "OK" }),
            f
        );
    }),
...
var getUrlParameter = function (t) {
    ...
    for (n = 0; n < i.length; n++) if ((e = i[n].split("="))[0] === t) return void 0 === e[1] || e[1];
};
function detectIE() {
...
jQuery.fn.extend({
    toggleText: function (t, e) {
        return this.text() != t && this.text() != e ? this.text(t) : this.text() == t ? this.text(e) : this.text() == e && this.text(t), this;
    },
}),
    (function (t, u) {
        var i,
        ...
        (e.throttle = i = function (o, r, s, a) {
            ...
            return "boolean" != typeof r && ((a = s), (s = r), (r = u)), e.guid && (t.guid = s.guid = s.guid || e.guid++), t;
        }),
                ...
                return (
                    this.each(function () {
                        ...
                        if (f.parent().hasClass(k.wrapperClass)) {
                            var p = f.scrollTop();
                            if (((y = f.siblings("." + k.barClass)), (b = f.siblings("." + k.railClass)), C(), D.isPlainObject(S))) {
                                ...
                                else if ("destroy" in S) return y.remove(), b.remove(), void f.unwrap();
                                x(p, !1, !0);
                            }
                        } else if (!(D.isPlainObject(S) && "destroy" in S)) {
                            k.height = "auto" == k.height ? f.parent().height() : k.height;
                            var m = D(c).addClass(k.wrapperClass).css({ position: "relative", overflow: "hidden", width: k.width, height: k.height });
                            f.css({ overflow: "hidden", width: k.width, height: k.height });
                            var v,
                                b = D(c)
                                ...
                                _ = "right" == k.position ? { right: k.distance } : { left: k.distance };
                            b.css(_),
                                y.css(_),
                                f.wrap(m),
                                f.parent().append(y),
                                        ...
                                        .bind("mousedown", function (e) {
                                            ...
                                            return (
                                                ...
                                                n.bind("mousemove.slimscroll", function (e) {
                                                    (currTop = t + e.pageY - pageY), y.css("top", currTop), x(0, y.position().top, !1);
                                                }),
                                ...
                                f.bind("touchmove", function (t) {
                                    h || t.originalEvent.preventDefault(), t.originalEvent.touches.length && (x((r - t.originalEvent.touches[0].pageY) / k.touchScrollStep, !0), (r = t.originalEvent.touches[0].pageY));
                                }),
                                C(),
                                "bottom" === k.start ? (y.css({ top: f.outerHeight() - y.outerHeight() }), x(0, !0)) : "top" !== k.start && (x(D(k.start).position().top, null, !0), k.alwaysVisible || y.hide()),
                                (v = this),
                                window.addEventListener ? (v.addEventListener("DOMMouseScroll", w, !1), v.addEventListener("mousewheel", w, !1)) : document.attachEvent("onmousewheel", w);
                        }
                        function w(t) {
                            if (i) {
                                var e = 0;
                        ...
                        function x(t, e, n) {
                            ...
                            if (
                                (e && ((i = parseInt(y.css("top")) + ((t * parseInt(k.wheelStep)) / 100) * y.outerHeight()), (i = Math.min(Math.max(i, 0), o)), (i = 0 < t ? Math.ceil(i) : Math.floor(i)), y.css({ top: i + "px" })),
                                ...
                                (r = Math.min(Math.max(r, 0), o)), y.css({ top: r + "px" });
                            }
                            f.scrollTop(i), f.trigger("slimscrolling", ~~i), E(), T();
                        }
                        function C() {
                            (s = Math.max((f.outerHeight() / f[0].scrollHeight) * f.outerHeight(), u)), y.css({ height: s + "px" });
                        ...
                        function E() {
                            ...
                            (l = a), s >= f.outerHeight() ? (h = !0) : (y.stop(!0, !0).fadeIn("fast"), k.railVisible && b.stop(!0, !0).fadeIn("fast"));
                        }
                        function T() {
                            k.alwaysVisible ||
                                (n = setTimeout(function () {
                                    (k.disableFadeOut && i) || e || o || (y.fadeOut("slow"), b.fadeOut("slow"));
                                }, 1e3));
                        }
                    }),
                    this
    ...
    (function (t, e) {
        ...
        function u(t) {
            ...
            return "[object String]" === e
                ? n(t)
                : i(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(e) && t.hasOwnProperty("length")
                ? t
                : (function (t) {
        ...
        function h(t) {
            ...
            return (
                ...
                { top: i.top + n.pageYOffset - e.clientTop, left: i.left + n.pageXOffset - e.clientLeft }
            );
        }
        function f(t) {
            var e = "";
        ...
        var p = {
                ...
                show: function (t, e, n) {
                    ...
                    var o = h(e),
                        r = 0,
                        s = 0;
                    (s = 0 <= (s = "touches" in t && t.touches.length ? ((r = t.touches[0].pageY - o.top), t.touches[0].pageX - o.left) : ((r = t.pageY - o.top), t.pageX - o.left)) ? s : 0), (r = 0 <= r ? r : 0);
                ...
                hide: function (t, e) {
                    for (var n = (e = e || this).getElementsByClassName("waves-rippling"), i = 0, o = n.length; i < o; i++) r(t, e, n[i]);
                    a && (e.removeEventListener("touchend", p.hide), e.removeEventListener("touchcancel", p.hide)), e.removeEventListener("mouseup", p.hide), e.removeEventListener("mouseleave", p.hide);
                },
            },
            l = {
                input: function (t) {
            ...
            if (null !== n) {
                ...
                if ((c.registerEvent(e), "touchstart" === e.type && p.delay)) {
                    var i = !1,
                        ...
                        r = function (t) {
                            o && (clearTimeout(o), (o = null), p.show(e, n)), i || ((i = !0), p.hide(t, n)), s();
                        },
                        t = function (t) {
                            o && (clearTimeout(o), (o = null)), r(t), s();
                        };
                    n.addEventListener("touchmove", t, !1), n.addEventListener("touchend", r, !1), n.addEventListener("touchcancel", r, !1);
                    var s = function () {
                        n.removeEventListener("touchmove", t), n.removeEventListener("touchend", r), n.removeEventListener("touchcancel", r);
                    };
                } else p.show(e, n), a && (n.addEventListener("touchend", p.hide, !1), n.addEventListener("touchcancel", p.hide, !1)), n.addEventListener("mouseup", p.hide, !1), n.addEventListener("mouseleave", p.hide, !1);
            }
        }
        return (
            (e.init = function (t) {
                ...
                "duration" in (t = t || {}) && (p.duration = t.duration),
                    ...
                    a && (e.addEventListener("touchstart", o, !1), e.addEventListener("touchcancel", c.registerEvent, !1), e.addEventListener("touchend", c.registerEvent, !1)),
                    e.addEventListener("mousedown", o, !1);
            }),
            (e.attach = function (t, e) {
                var n, i;
                (t = u(t)), "[object Array]" === s.call(e) && (e = e.join(" ")), (e = e ? " " + e : "");
                for (var o = 0, r = t.length; o < r; o++)
                    (i = (n = t[o]).tagName.toLowerCase()), -1 !== ["input", "img"].indexOf(i) && (l[i](n), (n = n.parentElement)), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e);
            }),
            (e.ripple = function (t, e) {
                ...
                if ((((e = e || {}).wait = e.wait || 0), (e.position = e.position || null), n))
                    for (
                        ...
                        if (
                            ((i = t[a]),
                            (o = e.position || { x: i.clientWidth / 2, y: i.clientHeight / 2 }),
                            (r = h(i)),
                            (s.x = r.left + o.x),
                            (s.y = r.top + o.y),
                            (l.pageX = s.x),
                            ...
                            setTimeout(c({ type: "mouseup", button: 1 }, i), e.wait);
                        }
            }),
            (e.calm = function (t) {
                for (var e = { type: "mouseup", button: 1 }, n = 0, i = (t = u(t)).length; n < i; n++) p.hide(e, t[n]);
            }),
        ...
        (a = "ontouchstart" in n || (n.DocumentTouch && t instanceof DocumentTouch) ? "click tap" : "click"),
            (r.prototype = {
                ...
                _loadKeys: function () {
                    ...
                    (this.storage.keySettings = "smartPanel_settings_" + t + "_" + this.objId), (this.storage.keyPosition = "smartPanel_position_" + t + "_" + this.objId);
                },
                _savePanelSettings: function () {
                    ...
                    var e = this.obj
                            ...
                            .map(function () {
                                var t = {};
                                return (t.id = g(this).attr("id")), (t.style = g(this).attr("data-panel-attstyle")), (t.locked = g(this).hasClass("panel-locked") ? 1 : 0), (t.collapsed = g(this).hasClass("panel-collapsed") ? 1 : 0), t;
                            })
                            .get(),
                        n = JSON.stringify({ panel: e });
                    t.enabled && t.getKeySettings != n && (localStorage.setItem(t.keySettings, n), (t.getKeySettings = n)),
                        "function" == typeof this.o.onSave && (this.o.onSave.call(this, null, n, t.keySettings), myapp_config.debugState && console.log("keySettings: " + t.keySettings));
                },
                            ...
                            .map(function () {
                                return {
                                    section: g(this)
                                        .children(t.o.panels)
                                        .map(function () {
                                            return { id: g(this).attr("id") };
                                        })
                                        .get(),
                                };
                            })
                            .get(),
                        i = JSON.stringify({ grid: n });
                    e.enabled && e.getKeyPosition != i && (localStorage.setItem(e.keyPosition, i), (e.getKeyPosition = i)), "function" == typeof t.o.onSave && t.o.onSave.call(this, i, e.keyPosition);
                },
                init: function () {
                    var p = this;
                    if (!p.initialized) {
                        if (
                            ...
                            for (var e in t.grid) {
                                ...
                                for (var i in t.grid[e].section) n.append(g("#" + t.grid[e].section[i].id));
                            }
                        }
                        if (p.storage.enabled && p.storage.getKeySettings) {
                            var o = JSON.parse(p.storage.getKeySettings);
                            for (var e in (myapp_config.debugState && console.log("Panel settings loaded: " + p.storage.getKeySettings), o.panel)) {
                        ...
                        if (p.o.panelColors && p.o.colorButton) {
                            ...
                            for (var e in p.o.panelColors)
                                d.push(
                                    '<a href="#" class="btn d-inline-block ' + p.o.panelColors[e] + ' width-2 height-2 p-0 rounded-0 js-panel-color hover-effect-dot" data-panel-setstyle="' + p.o.panelColors[e] + '" style="margin:1px;"></a>'
                                );
                        }
                        if (
                                    ...
                                    !0 === p.o.sortable && l.data("panel-sortable") === m && l.addClass("panel-sortable"),
                                        (t =
                                            !0 === p.o.closeButton && l.data("panel-close") === m
                                                ...
                                                : ""),
                                        (e =
                                            !0 === p.o.fullscreenButton && l.data("panel-fullscreen") === m
                                        ...
                                        !0 === p.o.refreshButton && l.data("panel-refresh") === m
                                            ? ((o = '<a href="#" class="dropdown-item js-panel-refresh"><span data-i18n="drpdwn.refreshpanel">' + p.o.refreshButtonLabel + "</span></a>"),
                                              u.prepend('<div class="loader"><i class="fal fa-spinner-third fa-spin-4x fs-xxl"></i></div>'))
                                            : (o = ""),
                                        (r =
                                        ...
                                        (s =
                                            !0 === p.o.resetButton && l.data("panel-reset") === m
                                                ? '<div class="dropdown-divider m-0"></div><a href="#" class="dropdown-item js-panel-reset"><span data-i18n="drpdwn.resetpanel">' + p.o.resetButtonLabel + "</span></a>"
                                                : ""),
                                        (a =
                                            !0 === p.o.customButton && l.data("panel-custombutton") === m
                                                ? '<a href="#" class="dropdown-item js-panel-custombutton pl-4"><span data-i18n="drpdwn.custombutton">' + p.o.customButtonLabel + "</span></a>"
                                                : ""),
                            ...
                            s.sortable({
                                ...
                                forceHelperSize: !0,
                                update: function (t, e) {
                                    p._runPanelLoader(e.item.children()), p._savePanelPosition(), "function" == typeof p.o.onChange && p.o.onChange.call(this, e.item);
                                },
                            });
                        }
                        p._clickEvents(),
                            p.storage.enabled &&
                                (g(p.o.deleteSettingsKey).on(a, this, function (t) {
                                    confirm(p.o.settingsKeyLabel) && localStorage.removeItem(keySettings), t.preventDefault();
                                }),
                                g(p.o.deletePositionKey).on(a, this, function (t) {
                                    confirm(p.o.positionKeyLabel) && localStorage.removeItem(keyPosition), t.preventDefault();
                                })),
                            (initialized = !0);
                    }
                },
                    ...
                    (t.enabled =
                        ...
                        !!(function () {
                            var t,
                                e = +new Date();
                            try {
                                return localStorage.setItem(e, e), (t = localStorage.getItem(e) == e), localStorage.removeItem(e), t;
                            } catch (t) {}
                        })()),
                        this._loadKeys(),
                        t.enabled && ((t.getKeySettings = localStorage.getItem(t.keySettings)), (t.getKeyPosition = localStorage.getItem(t.keyPosition)));
                },
                _clickEvents: function () {
                    ...
                    t.on(a, ".js-panel-collapse", function (t) {
                        ...
                        t.on(a, ".js-panel-close", function (t) {
                            ...
                            function o() {
                                n.fadeOut(500, function () {
                                    g(this).remove(), "function" == typeof r.o.onClosepanel && r.o.onClosepanel.call(this, n);
                                }),
                                    r._runPanelLoader(e);
                            }
                            initApp.playSound(myapp_config.assetsUrl + "/media/sound", "messagebox"),
                                "undefined" != typeof bootbox
                                    ? bootbox.confirm({
                                          ...
                                          centerVertical: !0,
                                          swapButtonOrder: !0,
                                          buttons: { confirm: { label: "Yes", className: "btn-danger shadow-0" }, cancel: { label: "No", className: "btn-default" } },
                        ...
                        t.on(a, ".js-panel-locked", function (t) {
                            var e = g(this),
                                n = e.closest(r.o.panels);
                            n.toggleClass("panel-locked"), r._runPanelLoader(e), "function" == typeof r.o.onLocked && r.o.onLocked.call(this, n), r._savePanelSettings(), t.preventDefault();
                        }),
                        t.on(a, ".js-panel-refresh", function (t) {
                            ...
                            e
                                ...
                                .delay(n)
                                .queue(function () {
                                    e.removeClass("panel-refresh").children(".panel-container").removeClass("enable-loader").dequeue(), console.log(e.attr("id") + " refresh complete");
                                }),
                ...
                destroy: function () {
                    ...
                    this.panel.removeClass("panel-sortable"), e.sortable("destroy"), this.panel.children(".panel-hdr").off(t), g(this.o.deletePositionKey).off(t), g(n).off(t), this.obj.removeData(o), (this.initialized = !1);
                },
            }),
            (g.fn[o] = function (i) {
                return this.each(function () {
